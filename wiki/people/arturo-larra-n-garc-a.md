...
display_name: Arturo Larraín García
person_id: arturo-larra-n-garc-a
tags: [person, source-mentioned, directory-listing]
---

# Arturo Larraín García

## Identity

- Preferred name: Arturo Larraín García.
- Identity status: source-mentioned exact name string from a reviewed 1959 medical directory row.

## Evidence Snapshot

This page exists only to hold the reviewed scoped directory-listing evidence. The reviewed source does not establish birth, death, residence duration, family relationship, or identity with any other canonical person.
