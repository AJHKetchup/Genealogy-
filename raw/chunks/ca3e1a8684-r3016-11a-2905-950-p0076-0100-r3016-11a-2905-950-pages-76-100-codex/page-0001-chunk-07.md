...
chunk_id: CHUNK-61e72ad58499-P0001-07
...
## Layout And Reading Order
This page is formatted into two main columns. The left column contains a large, detailed table listing hotels, their locations, and pricing information. The right column is a list of what appear to be hotel or place names, but it is cut off on the right side, making much of the text incomplete. The reading order is from top to bottom, starting with the left column's table and then proceeding to the partially visible right column.
...
| Duinoord * ........<br>*13 Sweelinckplein.* | 60 | 4.25 | 4.75 | 8.50 | 9.50 | 8.— | 12.50 | 12.50 | 12.50 | 8.— | — | 2.— | 2.50 |
...
## Uncertain Or Illegible
The right-hand column is cut off, making most of the text partial and uncertain. The following is a list of these partial readings:
- Kastee[?]
- Wass[?]
- Koning[?]
- mina[?]
...
## Completeness Audit
The transcription of the left column, which contains a large table of hotel information, is complete and accurate based on the visible text. The right column is physically cut off in the source image, and only the partial text visible has been transcribed.

## Visual Region Manifest
```json
{"visual_regions": [], "no_visual_regions_reason": "This page consists entirely of text, primarily in a tabular format, with no images, illustrations, or other visual elements."}
```
