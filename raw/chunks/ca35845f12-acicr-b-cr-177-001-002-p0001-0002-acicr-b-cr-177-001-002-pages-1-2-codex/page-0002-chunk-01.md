...
chunk_id: CHUNK-942ee5b188cc-P0002-01
source_converted: raw/converted/ca35845f12-acicr-b-cr-177-001-002-p0001-0002-acicr-b-cr-177-001-002-pages-1-2.codex.md
converted_sha256: 942ee5b188ccd9f7733dfbdd45a01935ce4e81aebc310da5c5b5237249a54827
...
The page is a single column of typewritten text. The reading order is from top to bottom. A header is at the top right. The main content is a numbered list of entries, from 17 to 37. There are handwritten notes in the left margin next to entries 20, 26, and 32.
...
37.- 25.2.29. A.r. de l/ ci-dessus, sommes reconnaissants au Dép. politi. de. bien vouloir auprès des Etats-Unis p[?] [illegible]
```

## Images, Captions, And Visual Notes
- Handwritten note in the left margin, next to entry 20: "plié".
- Handwritten note in the left margin, next to entry 26: "plié".
- Handwritten note in the left margin, next to entry 32: "m s.".

## Uncertain Or Illegible
- **Entry 37**: The end of the line is very faint and difficult to read. It begins "p" and is followed by illegible text. The transcription is `p[?] [illegible]`.

## Completeness Audit
The entire page has been transcribed, including the header, all numbered entries, and the handwritten marginalia. The final line of entry 37 is illegible due to the faintness of the ink.

## Visual Region Manifest
```json
{
  "visual_regions": [],
  "no_visual_regions_reason": "The page contains only typewritten text and minor handwritten marginalia, none of which qualify as distinct visual regions for cropping."
}
```
