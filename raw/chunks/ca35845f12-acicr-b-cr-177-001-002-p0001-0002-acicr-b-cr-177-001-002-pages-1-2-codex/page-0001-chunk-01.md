...
chunk_id: CHUNK-9f18b6fe15ef-P0001-01
source_converted: raw/converted/ca35845f12-acicr-b-cr-177-001-002-p0001-0002-acicr-b-cr-177-001-002-pages-1-2.codex.md
converted_sha256: 9f18b6fe15ef09f16959b8a420b4d20930aade60000aef49aad2477273902560
...
The page contains a header at the top right, with both typed and handwritten elements. The main content is a single-column, numbered list of 16 entries, each starting with a number and a date, followed by a descriptive sentence. There are three handwritten marginal notes on the left side of the page, corresponding to specific entries in the list.
...
- A handwritten annotation "CR 177-1" is present above the typed header "CR 177 CONFERENCE DIPLOMATIQUE".
- A handwritten number "1." is present below "CR 177-1".
...
```json
{"visual_regions": [], "no_visual_regions_reason": "No substantial visual elements like portraits, maps, or diagrams are present. Handwritten notes and header elements are transcribed in the literal transcription and described in visual notes."}
```
