# Cámara de Senadores de la Nación, 1936 pages 284-293

## Conversion Metadata

- Source: `raw/sources/Cámara de Senadores de la Nación, 1936.pdf`
- Source SHA-256: `221159bd9b79619cfbcad6b7d590f4fd91fff0a92ecd40b9972437ea865bb289`
- Manifest: `raw/codex-conversion-jobs/ca221159bd-c-mara-de-senadores-de-l-p0284-0293-c-mara-de-senadores-de-la-naci-n-1936-pages-284-293/manifest.json`
- Conversion method: Codex local vision workbench
- Extracted images: `raw/codex-conversion-jobs/ca221159bd-c-mara-de-senadores-de-l-p0284-0293-c-mara-de-senadores-de-la-naci-n-1936-pages-284-293/extracted-images`

## Page Metadata
Page number: 284

## Layout And Reading Order
The page contains a main title, a decree number, a date, an introductory paragraph, a "Decreta" heading, a section title, and then the body of the decree with articles and quoted text. The content is presented in a single column, with a page number at the bottom right.

## Literal Transcription
### Modificaciones al Decreto Reglamentario
(Decreto N° 56.445)

Buenos Aires, febrero 20 de 1935.

Teniendo en cuenta que la práctica aconseja introducir algunas
modificaciones y ampliaciones complementarias en el decreto
N° 14.137, de fecha 5 de diciembre de 1932, que reglamenta la Ley
N° Nacional de Vialidad N° 11.658;
...
Artículo 1° — Sustitúyase el artículo 26° del citado decreto
por el siguiente:
“El presupuesto anual efectivo para la construcción de ca-
minos”, a que se refiere el artículo 25° de la Ley N° 11.658, y “el
total invertido en obras de caminos”, a que se refiere el artículo
26° de la misma, serán computados en base a inversiones reales en
obras camineras en el ejercicio anterior.
En consecuencia quedan excluídos los gastos administrativos y
servicios financieros, y sólo comprenderá lo gastado o certificado
en el ejercicio con imputación a los recursos del mismo, en construc-
ción, conservación o mejoramiento de caminos, obras de arte, maqui-
narias, equipos, etc., que hayan sido pagados o no en dinero efectivo,
pero que estén incluídos en el balance del año.
De acuerdo a la disposición del artículo 55° de la Ley N° 11.584,
“entiéndese por gasto toda obra, adquisición o suministro, efectiva
y concretamente realizada en el año calendario”.
La Dirección Nacional de Vialidad fijará las modalidades a
...
## Completeness Audit
All visible text on the page has been transcribed. The last line of text is incomplete, as it appears to continue on the next page.
...
The page is a document cover. The content is arranged vertically, centered on the page. The reading order is from top to bottom:

1.  A handwritten 'x' in the top left corner.
2.  Header text: "REPÚBLICA ARGENTINA" and "MINISTERIO DE OBRAS PÚBLICAS".
3.  A red rectangular stamp is placed over the "MINISTERIO DE OBRAS PÚBLICAS" line and the title below it.
4.  Title: "LEY Nº 10650".
5.  Subtitle block: "CON LAS MODIFICACIONES INTRODUCIDAS POR LAS LEYES", "Nºs. 11074, 11173 y 11308", "Y", "DECRETOS REGLAMENTARIOS".
6.  A stamped note, "Distribución gratuita", is placed at an angle below the subtitle block.
7.  A small decorative flourish.
8.  Publication information at the bottom: "BUENOS AIRES", "TALLERES GRÁFICOS DEL MINISTERIO DE OBRAS PÚBLICAS", "1924".
...
[Red rectangular stamp with an inner double-line border]
[LEAGUE OF NATIONS?]
[LIBRARY?]
RECEIVED
14.FEB.1933
...
- The page is the cover of a government publication. The paper is aged and brownish-gray.
- A handwritten 'x' is present in the top left corner.
- A red rectangular stamp is located in the upper-middle section of the page. It contains four lines of text within a double-lined border. The text reads: "[LEAGUE OF NATIONS?]", "[LIBRARY?]", "RECEIVED", "14.FEB.1933". The top two lines are very faint.
- The text "Distribución gratuita" is printed at an angle, suggesting it was added with a separate stamp.
- A small, centered decorative flourish, resembling a stylized plant or fan, is located between the "Distribución gratuita" note and the publication details.

## Uncertain Or Illegible

- The top two lines of the red stamp are very faint and difficult to read with certainty.
- Line 1 of the stamp appears to be `[LEAGUE OF NATIONS?]`.
- Line 2 of the stamp appears to be `[LIBRARY?]`.

## Completeness Audit

This page is a document cover and has been fully transcribed. All text, including the stamp and handwritten mark, has been captured.
...
{
  "visual_regions": [],
  "no_visual_regions_reason": "The page contains a document cover with text, a stamp, and a small decorative element. None of these are substantial visual assets like portraits, maps, or detailed illustrations that would warrant individual cropping."
}
```
...
- Page number: 287
- Source publication year: 1936
- Source publication title: Cámara de Senadores de la Nación, 1936

## Layout And Reading Order

The page presents a title page layout with centered text. There are several lines of text, some of which are faded, followed by a handwritten stamp, a decorative rule, and then more faded text before the publication details at the bottom.
...
Objeto y constitución de la ley.

Artículo 1º—Créase la Caja Nacional de Jubilaciones y
Pensiones del Personal de Obras Públicas, con sujeción a las
disposiciones que establece esta ley.
Art. 2º—Quedan comprendidos en las disposiciones que
reglamentan el derecho a jubilación y pensión que acuerda esta
ley, los empleados y obreros permanentes, de las reparticiones
nacionales, incluso los ferrocarriles del Estado, con la excepción
de esta ley, de los empleados de puertos y depósitos de la Re-
pública, que presten servicios dentro de su territorio, que sean
desempeñados del Mercado Central de Buenos Aires, de las empresas
de la Caja creada que rige la ley y las demás empresas que
dependan de la misma, que no sean de carácter privado, y que
presten servicios a los mismos.
Art. 3º—El personal comprendido en las disposiciones
establecidas en el artículo anterior, tendrá derecho a jubilación
y pensión, siempre que reúna las condiciones que se establecen
en esta ley.
...
## Images, Captions, And Visual Notes
- A handwritten stamp "Distribución gratuita" appears diagonally across the faded text in the upper-middle section of the page.
- A small decorative rule, resembling a stylized star or flower, is centered below the handwritten stamp and above the faded text.

## Uncertain Or Illegible
The text below "DECRETOS REGLAMENTARIOS" and above "BUENOS AIRES" is very faded and difficult to read with certainty. The transcription above represents the best effort to read the visible characters.
...
{
  "visual_regions": [],
  "no_visual_regions_reason": "No substantial visuals like portraits, maps, or diagrams are present. The handwritten stamp and decorative rule are noted in the 'Images, Captions, And Visual Notes' section."
}
```
