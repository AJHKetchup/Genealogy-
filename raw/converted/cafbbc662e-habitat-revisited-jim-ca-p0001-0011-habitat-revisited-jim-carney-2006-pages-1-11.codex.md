...
## Layout And Reading Order
The page consists of a single column of text, with a page number in the top right corner. The text is organized into several paragraphs and one section header.
...
## Layout And Reading Order
The page consists of a single column of text, with a page number in the top right corner. The text is organized into several paragraphs and one heading.
