# Habitat Revisited, Jim Carney, 2006 pages 1-11

## Conversion Metadata

- Source: `raw/sources/Habitat Revisited, Jim Carney, 2006.pdf`
- Source SHA-256: `fbbc662e55670a0ad524c3f13256eaef1e62ef32b2b5d1417d601cb40f3313d9`
- Manifest: `raw/codex-conversion-jobs/cafbbc662e-habitat-revisited-jim-ca-p0001-0011-habitat-revisited-jim-carney-2006-pages-1-11/manifest.json`
- Conversion method: Codex local vision workbench
- Extracted images: `raw/codex-conversion-jobs/cafbbc662e-habitat-revisited-jim-ca-p0001-0011-habitat-revisited-jim-carney-2006-pages-1-11/extracted-images`

## Page Metadata
Page: 1

## Layout And Reading Order
The page presents text in a single column, starting with a page number at the top right, followed by a main title, subtitle information, a section heading, and then two paragraphs of body text. Another section heading follows, with a final paragraph of body text. The reading order is strictly top-to-bottom, left-to-right within the single column.
...
<u>Prepared for the World Urban Forum III</u>
<u>Vancouver, B.C. Canada, June 2006</u>
<u>(30th Anniversary of the United Nations Conference on Human Settlements</u>
<u>May 29-June 6, 1976, Vancouver, Canada)</u>
...
commercial building at the corner of Lexington Avenue and 46<sup>th</sup> St, being intro-
...
## Layout And Reading Order
The page consists of a single column of text, with a page number in the top right corner. The text is organized into several paragraphs, with one section heading "THE TASK".
...
lance director/cameraman Vladimir Bibic, had a special interest in Yemen. An em-
...
## Layout And Reading Order
The page contains a page number at the top right. The main content consists of a heading followed by seven paragraphs of text, presented in a single column.
...
## Layout And Reading Order
The page consists of a single column of text. The page number "4" is in the top right corner. The content flows from top to bottom in standard reading order. There are two bold, all-caps headings.

## Literal Transcription
4

We assembled another small and eclectic crew of film technicians, principally ed-
...
## Completeness Audit
The transcription is complete and accurate. All text, including page numbers and formatting, has been captured.
...
## Layout And Reading Order
The page consists of a single column of text. The page number "5" is in the top right corner. The text flows continuously in standard paragraph blocks, with one bolded heading "SHOWTIME !".
...
Criehton Douglas and by and large, in the event, it worked.
...
air”. The late delivery of the films had severely impeded Leiderman’s versioning and
...
## Uncertain Or Illegible
- "Criehton Douglas" might be "Crichton Douglas" (common spelling), but transcribed as seen.
- "Pulgar" is transcribed as seen, but could be a typo for a name like "Pulgar".
- "Bute/Thurlow ??" - The source explicitly uses two question marks, indicating uncertainty in the original text.
...
## Layout And Reading Order
The page consists of a single column of text, with a page number in the top right corner. The text is organized into several paragraphs, with one bolded heading.
...
## Layout And Reading Order
The page consists of a page number in the top right corner, followed by five distinct paragraphs of text, presented in a single column.

## Literal Transcription
the 26^th^ and 27^th^ floors of the 28-storey Kenyatta Conference Centre in downtown
...
with great specificity the tasks each division would complete over UNCHS’s first two
...
The page is a single column of text. The page number "10" is at the top right corner. The main body of text is divided into several paragraphs. There is one bolded, capitalized section header, "IN THE END – WHY ?", which separates the paragraphs. The reading order is sequential from top to bottom.

## Literal Transcription

10

By early 1980, with UNCHS more or less operational in Nairobi, Andreas Fuglesang was appointed Chief of the Division of Information, Audio-Visual and Information. He assembled a team, some local Kenyans (black and white), some young expats (Indians, Brits and Aussies), some UN professionals (particularly for the translation chores, where accuracy is critical). I remained at the erstwhile Vision Habitat offices at UBC, with Phyllis Eleazar, as the “UNCHS Information Officer for North America and the Caribbean”. I dreaded being introduced to people and being asked “and what do you do ?”. I could see their eyes glaze over as I tried to explain.

In March of 1983, Andreas returned to Sweden to take up a post with the Dag Hammarskjold Foundation. He proposed (indeed insisted) that I go to Nairobi as his replacement. For personal reasons, I agreed to go only on a temporary basis.

I arrived in Nairobi, at UNCHS headquarters in Gigiri, in March, 1983. I’d met many of the members of Andreas’ team on previous occasions and we got along well. They were competent, dedicated and reliable. The work load was horrendous. It was six months before I took a day off. I was not unusual in that regard.

Nonetheless, I found the work and the challenges exhilarating. At the end of my first six weeks, I met with UNCHS’ Executive Director, Dr. Ramachandran, a man of incandescent intelligence and energy, and told him I had changed my mind and wanted the job on a more permanent basis. I remained in the post until April, 1986, when I returned to my hometown, Vancouver, as Commissioner General of the UN pavilion at Expo ‘86. And that’s another story !!

**IN THE END – WHY ?**

I spent a total of thirteen years on the Habitat programme. I was and still am frequently asked “What is the value of these global UN conferences ?”, “Do they change anything ?”, “Was it worth it ?”. My answer is a resounding “Yes !” Fundamentally, in brief, because such global conferences put pressure on governments to collectively agree to identify, acknowledge, discuss, exchange information and develop and compare solutions to overarching global problems. Responsible ministers gain clout at the cabinet table; issues they represent rise higher on government agendas. Such conferences help establish norms, advancing the goal posts of what is considered acceptable behaviour.

The degree to which improvement actually occurs is dependent on the will, priorities and resources of individual governments – including donor states - who simultaneously must confront and deal with other huge problems.

Only in retrospect can I truly appreciate how innovative and audacious the audiovisual programme of the 1976 Habitat Conference was. Today, the international and instantaneous exchange of unimaginable volumes of audio, visual and textual information and data by electronic means is taken for granted. Thirty years ago, with rare exceptions (usually military), information existed principally in the form of documents, audio, video tape and film and had to be physically flown and shipped across continents and oceans.

## Images, Captions, And Visual Notes

There are no images, captions, or other visual elements on this page. The page consists entirely of text.
