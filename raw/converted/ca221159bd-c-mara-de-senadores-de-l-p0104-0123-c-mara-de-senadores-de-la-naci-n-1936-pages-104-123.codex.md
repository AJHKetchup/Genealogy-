...
The page features a central column of text and diagrams, with some partial text visible in the left margin. The main content begins with a page number at the top center, followed by a main heading. Below this, there are three sections, each describing a type of signal ("Señales de dos aspectos", "Señales de tres aspectos", "Señales de cuatro aspectos"). Each section contains multiple diagrams of signals, each with a descriptive label below it. The diagrams are arranged horizontally within their respective sections.
...
- ![nearby-text: Peligro.](../extracted-images/page-0104/page-0104-image-01-signal-diagram-peligro-two-aspects.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [10.5, 28.5, 14.5, 35.5]
  - Source context: Señales de dos aspectos
- ![nearby-text: Vía libre.](../extracted-images/page-0104/page-0104-image-02-signal-diagram-via-libre-two-aspects-1.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [24.5, 28.5, 28.5, 35.5]
  - Source context: Señales de dos aspectos
- ![nearby-text: Precaución.](../extracted-images/page-0104/page-0104-image-03-signal-diagram-precaucion-two-aspects.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [45.5, 28.5, 49.5, 35.5]
  - Source context: Señales de dos aspectos
- ![nearby-text: Vía libre.](../extracted-images/page-0104/page-0104-image-04-signal-diagram-via-libre-two-aspects-2.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [60.5, 28.5, 64.5, 35.5]
  - Source context: Señales de dos aspectos
- ![nearby-text: Peligro](../extracted-images/page-0104/page-0104-image-05-signal-diagram-peligro-three-aspects.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [10.5, 49.5, 14.5, 58.5]
  - Source context: Señales de tres aspectos
- ![nearby-text: Precaución](../extracted-images/page-0104/page-0104-image-06-signal-diagram-precaucion-three-aspects.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [37.5, 49.5, 41.5, 58.5]
  - Source context: Señales de tres aspectos
- ![nearby-text: Vía libre](../extracted-images/page-0104/page-0104-image-07-signal-diagram-via-libre-three-aspects.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [60.5, 49.5, 64.5, 58.5]
  - Source context: Señales de tres aspectos
- ![nearby-text: Peligro](../extracted-images/page-0104/page-0104-image-08-signal-diagram-peligro-four-aspects.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [10.5, 70.5, 14.5, 81.5]
  - Source context: Señales de cuatro aspectos
- ![nearby-text: Precaución](../extracted-images/page-0104/page-0104-image-09-signal-diagram-precaucion-four-aspects.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [29.5, 70.5, 33.5, 81.5]
  - Source context: Señales de cuatro aspectos
- ![nearby-text: Prec. avanzada](../extracted-images/page-0104/page-0104-image-10-signal-diagram-prec-avanzada-four-aspects.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [48.5, 70.5, 52.5, 81.5]
  - Source context: Señales de cuatro aspectos
- ![nearby-text: Vía libre](../extracted-images/page-0104/page-0104-image-11-signal-diagram-via-libre-four-aspects.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [67.5, 70.5, 71.5, 81.5]
  - Source context: Señales de cuatro aspectos

The page contains several diagrams illustrating different types of luminous signals. Each diagram shows a vertical rectangular box with circular lights inside, some of which are colored (red, green, or yellow) to indicate a specific state.

- **Signal Diagram 1 (Peligro - two aspects):** A vertical rectangular box with two circular lights. The bottom light is red, and the top light is unlit.
- **Signal Diagram 2 (Vía libre - two aspects):** A vertical rectangular box with two circular lights. The top light is green, and the bottom light is unlit.
- **Signal Diagram 3 (Precaución - two aspects):** A vertical rectangular box with two circular lights. The bottom light is yellow, and the top light is unlit.
- **Signal Diagram 4 (Vía libre - two aspects):** A vertical rectangular box with two circular lights. The top light is green, and the bottom light is unlit.
- **Signal Diagram 5 (Peligro - three aspects):** A vertical rectangular box with three circular lights. The bottom light is red, and the middle and top lights are unlit.
- **Signal Diagram 6 (Precaución - three aspects):** A vertical rectangular box with three circular lights. The middle light is yellow, and the bottom and top lights are unlit.
- **Signal Diagram 7 (Vía libre - three aspects):** A vertical rectangular box with three circular lights. The top light is green, and the bottom and middle lights are unlit.
- **Signal Diagram 8 (Peligro - four aspects):** A vertical rectangular box with four circular lights. The bottom light is red, and the other three lights are unlit.
- **Signal Diagram 9 (Precaución - four aspects):** A vertical rectangular box with four circular lights. The second light from the top is yellow, and the other three lights are unlit.
- **Signal Diagram 10 (Prec. avanzada - four aspects):** A vertical rectangular box with four circular lights. The third light from the top is yellow, and the other three lights are unlit.
- **Signal Diagram 11 (Vía libre - four aspects):** A vertical rectangular box with four circular lights. The top light is green, and the other three lights are unlit.

## Uncertain Or Illegible
None.

## Completeness Audit
All visible text and diagrams on the page have been transcribed and described. The partial text in the left margin has been included.
  ...
  "visual_regions": [
    {
      "region_id": "vr_1",
      "kind": "diagram",
      "bbox_pct": [10.5, 28.5, 14.5, 35.5],
      "caption_literal": "Peligro.",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de dos aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_peligro_two_aspects.png",
      "inline_anchor": "Signal Diagram 1 (Peligro - two aspects):"
    },
    {
      "region_id": "vr_2",
      "kind": "diagram",
      "bbox_pct": [24.5, 28.5, 28.5, 35.5],
      "caption_literal": "Vía libre.",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de dos aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_via_libre_two_aspects_1.png",
      "inline_anchor": "Signal Diagram 2 (Vía libre - two aspects):"
    },
    {
      "region_id": "vr_3",
      "kind": "diagram",
      "bbox_pct": [45.5, 28.5, 49.5, 35.5],
      "caption_literal": "Precaución.",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de dos aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_precaucion_two_aspects.png",
      "inline_anchor": "Signal Diagram 3 (Precaución - two aspects):"
    },
    {
      "region_id": "vr_4",
      "kind": "diagram",
      "bbox_pct": [60.5, 28.5, 64.5, 35.5],
      "caption_literal": "Vía libre.",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de dos aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_via_libre_two_aspects_2.png",
      "inline_anchor": "Signal Diagram 4 (Vía libre - two aspects):"
    },
    {
      "region_id": "vr_5",
      "kind": "diagram",
      "bbox_pct": [10.5, 49.5, 14.5, 58.5],
      "caption_literal": "Peligro",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de tres aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_peligro_three_aspects.png",
      "inline_anchor": "Signal Diagram 5 (Peligro - three aspects):"
    },
    {
      "region_id": "vr_6",
      "kind": "diagram",
      "bbox_pct": [37.5, 49.5, 41.5, 58.5],
      "caption_literal": "Precaución",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de tres aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_precaucion_three_aspects.png",
      "inline_anchor": "Signal Diagram 6 (Precaución - three aspects):"
    },
    {
      "region_id": "vr_7",
      "kind": "diagram",
      "bbox_pct": [60.5, 49.5, 64.5, 58.5],
      "caption_literal": "Vía libre",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de tres aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_via_libre_three_aspects.png",
      "inline_anchor": "Signal Diagram 7 (Vía libre - three aspects):"
    },
    {
      "region_id": "vr_8",
      "kind": "diagram",
      "bbox_pct": [10.5, 70.5, 14.5, 81.5],
      "caption_literal": "Peligro",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de cuatro aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_peligro_four_aspects.png",
      "inline_anchor": "Signal Diagram 8 (Peligro - four aspects):"
    },
    {
      "region_id": "vr_9",
      "kind": "diagram",
      "bbox_pct": [29.5, 70.5, 33.5, 81.5],
      "caption_literal": "Precaución",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de cuatro aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_precaucion_four_aspects.png",
      "inline_anchor": "Signal Diagram 9 (Precaución - four aspects):"
    },
    {
      "region_id": "vr_10",
      "kind": "diagram",
      "bbox_pct": [48.5, 70.5, 52.5, 81.5],
      "caption_literal": "Prec. avanzada",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de cuatro aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_prec_avanzada_four_aspects.png",
      "inline_anchor": "Signal Diagram 10 (Prec. avanzada - four aspects):"
    },
    {
      "region_id": "vr_11",
      "kind": "diagram",
      "bbox_pct": [67.5, 70.5, 71.5, 81.5],
      "caption_literal": "Vía libre",
      "caption_type": "nearby-text",
      "identity_basis": null,
      "source_context": "Señales de cuatro aspectos",
      "confidence": 0.95,
      "suggested_filename": "signal_diagram_via_libre_four_aspects.png",
...
## Layout And Reading Order
The page begins with a centered page number, followed by a section heading and introductory text. Below this, there are two main diagrams illustrating different signal states, each accompanied by descriptive text. The first diagram shows a "Normal" signal, and the second shows two examples of a "Vía Libre" signal.
...
Pipeline-extracted visual crops:
- ![nearby-text: Normal
(Ninguna indicación)](../extracted-images/page-0106/page-0106-image-01-diagram-normal-signal.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [23.0, 22.0, 43.0, 48.0]
  - Source context: This diagram illustrates a signal in its 'Normal' state, indicating 'Ninguna indicación' (No indication).
- ![nearby-text: Vía Libre
(Mostrando una cifra o una letra)](../extracted-images/page-0106/page-0106-image-02-diagram-via-libre-signals.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [22.0, 57.0, 78.0, 88.0]
  - Source context: This diagram illustrates two examples of a 'Vía Libre' (Clear Track) signal, showing either a number ('3') or a letter ('A').

The page contains two diagrams illustrating railway signals.

The first diagram, labeled "Normal (Ninguna indicación)", depicts a signal pole with a horizontal red and white striped bar and a red circular light to its right. Below the bar, a black square is attached to the pole.
The second diagram, labeled "Vía Libre (Mostrando una cifra o una letra)", shows two identical signals. Each signal pole has a red and white striped bar angled upwards to the right, with a green circular light to its right. Below the left signal's bar, a black square displays the number "3". Below the right signal's bar, a black square displays the letter "A".
  ...
  "visual_regions": [
    {
      ...
      "caption_literal": "Normal\n(Ninguna indicación)",
      "caption_type": "nearby-text",
      "identity_basis": "source-context",
      "source_context": "This diagram illustrates a signal in its 'Normal' state, indicating 'Ninguna indicación' (No indication).",
      "confidence": 0.95,
      "suggested_filename": "diagram-normal-signal"
    },
    {
      "region_id": "vr_2",
      "kind": "diagram",
      ...
      "caption_type": "nearby-text",
      "identity_basis": "source-context",
      "source_context": "This diagram illustrates two examples of a 'Vía Libre' (Clear Track) signal, showing either a number ('3') or a letter ('A').",
      "confidence": 0.95,
      "suggested_filename": "diagram-via-libre-signals"
    }
  ]
}
```
...
## Layout And Reading Order
The page presents a single-column layout with descriptive text and accompanying illustrations of railway signals. The content is structured into numbered sections, each detailing a specific type of signal or indicator. Illustrations are interspersed within the text, generally appearing before or alongside their descriptions.

## Literal Transcription

— 108 —

2º Señales enanas: Las señales
enanas serán de la misma for-
ma que las señales de brazos no
automáticas, pero de dimen-
siones más reducidas, y se ha-
rán con ellas las mismas indi-
caciones que con las señales de
brazos de dos posiciones
.
3º Indicadores de cambios: Los
indicadores que funcionan jun-
tos con los cambios, para in-
dicar la posición de los mismos,
deben ser tales que sus luces
no puedan ser confundidas con
las de las señales.
Estos indicadores se coloca-
rán en los cambios de vías prin-
cipales y en las vías segundas
que no estén controladas por
ninguna señal.
...
4º Discos o tableros de precaución:

a) Discos de aproximación: Cuando se usen discos
de aproximación, éstos se colocarán como mí-
nimo a 1400 metros afuera del primer cambio
de las estaciones, desvíos, empalme, etc., con el
fin de permitir a los conductores de trenes orien-
tarse de noche o cuando haya neblina, etc.
La cara de estos discos, expuesta a los trenes
que se aproximan a la estación, etc., será pin-
tada de blanco, la otra de negro y no llevarán
luz alguna.

## Images, Captions, And Visual Notes
Pipeline-extracted visual crops:
- ![nearby-text: 2º Señales enanas: Las señales enanas serán de la misma forma que las señales de brazos no automáticas, pero de dimensiones más reducidas, y se harán con ellas las mismas indicaciones que con las señales de brazos de dos posiciones](../extracted-images/page-0111/page-0111-image-01-dwarf-signals.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [14.0, 24.0, 27.0, 50.0]
  - Source context: Two illustrations of dwarf signals, one angled down with a green light, the other horizontal with a red light.
- ![nearby-text: A vía recta](../extracted-images/page-0111/page-0111-image-02-switch-indicators-straight-track.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [34.0, 24.0, 43.0, 40.0]
  - Source context: Two illustrations of switch indicators, both showing a straight track configuration.
- ![nearby-text: A desvío](../extracted-images/page-0111/page-0111-image-03-switch-indicators-diverging-track.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [46.0, 24.0, 55.0, 50.0]
  - Source context: Two illustrations of switch indicators, both showing a diverging track configuration with arrows.
- ![nearby-text: a) Discos de aproximación: Cuando se usen discos de aproximación, éstos se colocarán como mínimo a 1400 metros afuera del primer cambio de las estaciones, desvíos, empalme, etc., con el fin de permitir a los conductores de trenes orientarse de noche o cuando haya neblina, etc. La cara de estos discos, expuesta a los trenes que se aproximan a la estación, etc., será pintada de blanco, la otra de negro y no llevarán luz alguna.](../extracted-images/page-0111/page-0111-image-04-approach-disc.png)
  - Kind: diagram; label basis: nearby-text; bbox_pct: [70.0, 24.0, 81.0, 30.0]
  - Source context: An illustration of a circular disc on a post, representing an approach disc.

The page contains several illustrations of railway signals and indicators.

*   **Visual 1**: Two dwarf signals are depicted. The left signal shows a red and white striped arm angled downwards to the left, with a green light. The right signal shows a red and white striped arm horizontal, with a red light. These illustrate the "Señales enanas" described in section 2º.
*   **Visual 2**: Two switch indicators are shown side-by-side. Both are black rectangular boxes on posts. The text "A vía recta" is next to them, indicating they represent a straight track.
*   **Visual 3**: Two more switch indicators are shown below the previous pair. These are also black rectangular boxes on posts, but each has a white arrow pointing horizontally (left arrow on the left indicator, right arrow on the right indicator). The text "A desvío" is next to them, indicating they represent a diverging track.
*   **Visual 4**: A single illustration of a circular disc on a post, representing a "Disco de aproximación" (approach disc) as described in section 4º a).
  ...
  "visual_regions": [
    {
      "region_id": "region_1",
      "kind": "diagram",
      "bbox_pct": [14.0, 24.0, 27.0, 50.0],
      "caption_literal": "2º Señales enanas: Las señales enanas serán de la misma forma que las señales de brazos no automáticas, pero de dimensiones más reducidas, y se harán con ellas las mismas indicaciones que con las señales de brazos de dos posiciones",
      "caption_type": "nearby-text",
      "identity_basis": "source-context",
      "source_context": "Two illustrations of dwarf signals, one angled down with a green light, the other horizontal with a red light.",
      "confidence": 0.95,
      "suggested_filename": "dwarf_signals"
    },
    {
      "region_id": "region_2",
      "kind": "diagram",
      "bbox_pct": [34.0, 24.0, 43.0, 40.0],
      "caption_literal": "A vía recta",
      "caption_type": "nearby-text",
      "identity_basis": "source-context",
      "source_context": "Two illustrations of switch indicators, both showing a straight track configuration.",
      "confidence": 0.95,
      "suggested_filename": "switch_indicators_straight_track"
    },
    {
      "region_id": "region_3",
      "kind": "diagram",
      "bbox_pct": [46.0, 24.0, 55.0, 50.0],
      "caption_literal": "A desvío",
      "caption_type": "nearby-text",
      "identity_basis": "source-context",
      "source_context": "Two illustrations of switch indicators, both showing a diverging track configuration with arrows.",
      "confidence": 0.95,
      "suggested_filename": "switch_indicators_diverging_track"
    },
    {
      "region_id": "region_4",
      "kind": "diagram",
      "bbox_pct": [70.0, 24.0, 81.0, 30.0],
      "caption_literal": "a) Discos de aproximación: Cuando se usen discos de aproximación, éstos se colocarán como mínimo a 1400 metros afuera del primer cambio de las estaciones, desvíos, empalme, etc., con el fin de permitir a los conductores de trenes orientarse de noche o cuando haya neblina, etc. La cara de estos discos, expuesta a los trenes que se aproximan a la estación, etc., será pintada de blanco, la otra de negro y no llevarán luz alguna.",
      "caption_type": "nearby-text",
      "identity_basis": "source-context",
      "source_context": "An illustration of a circular disc on a post, representing an approach disc.",
      "confidence": 0.95,
      "suggested_filename": "approach_disc"
    }
  ]
}
```
...
The page contains a page number centered at the top, followed by a block of text. Below this, there is a numbered list with sub-items, some of which are accompanied by illustrations. The text is presented in a single column.

## Literal Transcription

— 111 —

Si las locomotoras marcharán con el ténder adelante
llevarán en dicho ténder un farol de igual potencia que
el que lleva la locomotora al frente de su posición
normal.

2º Como señales de cola, todo tren llevará:

a) De día: Colocado en los ángulos
superiores del último vehículo,
dos discos (uno a cada lado) pin-
tados de blanco hacia adelante y
rojo hacia atrás, excepto en los
trenes que estuvieren dotados to-
talmente de frenos continuos au-
tomáticos.

b) De noche: Colocados a cada uno
de los costados, en los ángulos su-
periores del último vehículo, un
farol de costado proyectando luz
blanca hacia adelante y roja ha-
cia atrás.

3º Cuando circulen solas las locomo-
toras o coches automotores, llevarán
como señal de cola, en la parte pos-
terior del vehículo, durante la noche,
un farol proyectando luz roja hacia
atrás.

4º En casos especiales la Dirección General de Ferroca-
rriles podrá autorizar la supresión de los discos, como
asimismo el empleo de las señales de cola de noche en
substitución de las previstas en los incisos 2º, subinciso
a) y 3º.

## Images, Captions, And Visual Notes

Pipeline-extracted visual crops:
- ![nearby-text: Illustration depicting the rear of a train car with two circular signals on the upper corners, corresponding to item 2a 'De día'.](../extracted-images/page-0114/page-0114-image-01-train-car-tail-signals-daytime.png)
  - Kind: illustration; label basis: nearby-text; bbox_pct: [90.0, 79.0, 100.0, 100.0]
  - Source context: Illustration depicting the rear of a train car with two circular signals on the upper corners, corresponding to item 2a 'De día'.
- ![nearby-text: Illustration depicting the rear of a train car with two circular signals on the upper corners and a central lamp, corresponding to item 2b 'De noche'.](../extracted-images/page-0114/page-0114-image-02-train-car-tail-signals-nighttime.png)
  - Kind: illustration; label basis: nearby-text; bbox_pct: [90.0, 79.0, 100.0, 100.0]
  - Source context: Illustration depicting the rear of a train car with two circular signals on the upper corners and a central lamp, corresponding to item 2b 'De noche'.
- ![nearby-text: Illustration depicting the rear of a train car or locomotive with a single central lamp, corresponding to item 3 'Cuando circulen solas las locomotoras o coches automotores'.](../extracted-images/page-0114/page-0114-image-03-locomotive-tail-signal-single.png)
  - Kind: illustration; label basis: nearby-text; bbox_pct: [90.0, 79.0, 100.0, 100.0]
  - Source context: Illustration depicting the rear of a train car or locomotive with a single central lamp, corresponding to item 3 'Cuando circulen solas las locomotoras o coches automotores'.

The page includes three illustrations depicting the rear of a train car with different signal configurations, corresponding to the rules described in the text.

*   **Visual 1**: An illustration of the rear of a train car, showing two circular signals (discs) mounted on the upper corners. This visual corresponds to the description in item 2a regarding daytime tail signals.
*   **Visual 2**: An illustration of the rear of a train car, showing two circular signals (discs) on the upper corners and a central lamp. This visual corresponds to the description in item 2b regarding nighttime tail signals.
*   **Visual 3**: An illustration of the rear of a train car or locomotive, showing a single central lamp. This visual corresponds to the description in item 3 regarding tail signals for single locomotives or automotors.
  ...
  "visual_regions": [
    {
      "region_id": "region_1",
      "kind": "illustration",
      "bbox_pct": [90.0, 79.0, 279.0, 269.0],
      "caption_literal": null,
      "caption_type": "nearby-text",
      "identity_basis": "visual-content",
      "source_context": "Illustration depicting the rear of a train car with two circular signals on the upper corners, corresponding to item 2a 'De día'.",
      "confidence": 0.95,
      "suggested_filename": "train_car_tail_signals_daytime.png",
      "inline_anchor": "a) De día: Colocado en los ángulos\nsuperiores del último vehículo,\ndos discos (uno a cada lado) pin-\ntados de blanco hacia adelante y\nrojo hacia atrás, excepto en los\ntrenes que estuvieren dotados to-\ntalmente de frenos continuos au-\ntomáticos."
    },
    {
      "region_id": "region_2",
      "kind": "illustration",
      "bbox_pct": [90.0, 79.0, 599.0, 269.0],
      "caption_literal": null,
      "caption_type": "nearby-text",
      "identity_basis": "visual-content",
      "source_context": "Illustration depicting the rear of a train car with two circular signals on the upper corners and a central lamp, corresponding to item 2b 'De noche'.",
      "confidence": 0.95,
      "suggested_filename": "train_car_tail_signals_nighttime.png",
      "inline_anchor": "b) De noche: Colocados a cada uno\nde los costados, en los ángulos su-\nperiores del último vehículo, un\nfarol de costado proyectando luz\nblanca hacia adelante y roja ha-\ncia atrás."
    },
    {
      "region_id": "region_3",
      "kind": "illustration",
      "bbox_pct": [90.0, 79.0, 754.0, 269.0],
      "caption_literal": null,
      "caption_type": "nearby-text",
      "identity_basis": "visual-content",
      "source_context": "Illustration depicting the rear of a train car or locomotive with a single central lamp, corresponding to item 3 'Cuando circulen solas las locomotoras o coches automotores'.",
      "confidence": 0.95,
      "suggested_filename": "locomotive_tail_signal_single.png",
      "inline_anchor": "3º Cuando circulen solas las locomo-\ntoras o coches automotores, llevarán\ncomo señal de cola, en la parte pos-\nterior del vehículo, durante la noche,\nun farol proyectando luz roja hacia\natrás."
    }
  ]
}
```
...
The page contains a page number at the top center, followed by several articles (Art. 106, Art. 107, Art. 108, Art. 109) each preceded by a heading. The content flows in a single column.
...
Art. 106.— Las zorras que se encuentren en la vía llevarán
señales de peligro de día y de noche. Cuando se utilicen para
el servicio de las cuadrillas o guardahilos zorras o triciclos a
motor, éstos deberán estar provistos de silbato, sirena o bo-
cina y circulando de noche, de un farol delantero que ilu-
mine el camino a una distancia prudencial.

Comunicación entre los pasajeros
jefes y los conductores de los trenes

Art. 107.— En los trenes de pasajeros y mixtos, los pasa-
jeros deberán poder comunicarse, en cualquier momento, con
el jefe del tren, y éste con el conductor del mismo, para dar,
en caso de peligro, el aviso o la señal de alarma.

Sistemas de comunicación entre los
pasajeros, jefes y conductores de los
trenes. Clausura de puertas inte-
riores.

Art. 108.— Para la intercomunicación entre los pasajeros y
empleados del tren con el conductor, las empresas podrán usar
los sistemas que crean más convenientes, debiendo someterlos a
la aprobación de la Dirección General de Ferrocarriles.
En los trenes desprovistos de dispositivos especiales que per-
mitan la comunicación del público con el personal no podrán
intercalarse vehículos cerrados entre los ocupados por los pasa-
jeros y el en que puede hallarse el jefe del tren.
En casos especiales, y previa autorización de la Dirección Ge-
neral de Ferrocarriles, podrá cerrarse una puerta interior
siempre que un guarda permanezca vigilando junto a la misma.

Protección de trenes detenidos en
la vía.

Art. 109.— Los trenes que se detengan entre estaciones fuera
de los casos en que lo hagan por indicación de una señal de pa-
rada absoluta, de una estación, desvío, empalme o garita de se-
...
The page contains a single column of text, primarily composed of regulations or articles. There's a page number centered at the top. The text is structured with paragraphs and numbered articles, along with a couple of subheadings.
...
Cuando el estado de la vía sea tal que no resulte prudente
usar esa velocidad, se hará la señal de peligro y se detendrá el
tren para darle al conductor instrucciones verbales sobre las
precauciones a observar.

Las precauciones permanentes o temporarias de cierta du-
ración deberán ser puestas en conocimiento de los conductores
por medio de avisos colocados en los respectivos galpones y ta-
bleros fijos indicadores de las velocidades máximas a observar
entre los puntos señalados.

Hasta tanto no se llene este requisito, las estaciones inme-
diatas al punto de peligro entregarán a los conductores de trenes
boletas indicando los puntos entre los cuales deberán observar
precaución y la velocidad máxima con que podrán recorrer ese
trayecto.

Protección de locomotoras solas.

Art. 112. — Cuando corra una locomotora sola y sea nece-
sario protegerla, el conductor mandará al foguista o al ayu-
dante de conductor, según el caso, a que lo haga.

Señales de noche. Horas de funcio-
namiento.

Art. 113. — El uso de las señales de noche es obligatorio
desde que el sol se pone hasta su salida.
```
