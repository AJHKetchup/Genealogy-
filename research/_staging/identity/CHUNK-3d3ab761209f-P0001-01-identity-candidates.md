...
| --- | --- | --- | --- | --- |
| id-513-child | Create/reconcile person: Jose Luis Pulgar Amagada, male, born in entry 513 at Calle Colon, Los Angeles registration district. | Assigned chunk: "**Nombre.** Pulgar Amagada<br>José Luis"; "**Sexo.**<br>Masculino"; converted file conflicts with `Tulio Cesar Luis Jose`. | Name parsing and exact birth date/time should wait for targeted image QA. | `hold_for_conversion_qa` |
...
| id-514-child | Create/reconcile person: Juan Bautista Riquelme Aviles, male, born 23 June 1889, in the entry 514 place field. | Assigned chunk: "**Nombre.**<br>Riquelme Aviles<br>Juan Bautista"; converted file conflicts with `Rigoberto Juan Bautista`. | Street name and child surname/given-name structure require conversion QA. | `hold_for_conversion_qa` |
...
| id-514-witness-1 | Possible witness identity: Benjamin Utiera. | "**Por los testigos:**<br>Benjamin Utiera" | Conversion specifically says surname `Utiera` is somewhat difficult to read. | Do not merge; hold for image review. |
| id-514-witness-2 | Possible witness identity: Ignacio Soto. | "**Por los testigos:**<br>Benjamin Utiera<br>Ignacio Soto" | Witness-only mention; no age/residence. | Low priority; do not merge without corroboration. |
...
| id-515-mother | Create/reconcile person: Carmen Ulloa, Chilean, domiciled Santiago. | Assigned chunk: "**Nombre de la madre.**<br>Carmen Ulloa"; converted file conflicts with `Carmen Fuentes`. | Lower-row crop prevents confident image confirmation in this pass. | `hold_for_conversion_qa` |
| id-515-witnesses | Possible witness identities: Rosendo Ramirez H.; Santiago Perez. | "**Por los testigos:**<br>Rosendo Ramirez H.<br>Santiago Perez" | Witness-only mentions; accents omitted in conversion. | Low priority; do not merge without corroboration. |
