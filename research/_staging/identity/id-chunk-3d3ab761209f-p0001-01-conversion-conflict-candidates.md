...
Chunk/page reference: `raw/chunks/ca05d0627a-registro-de-nacimientos-registro-de-nacimientos-circunscripci-n-de-los-ngeles-chile-1889-certificate-no-513-codex/page-0001-chunk-01.md`, image page 1, register page 172, entries 513-515.
...
- Entry 515 mother: Carmen Ulloa, Chilean, domiciled Santiago.

## Literal Support

See the individual claim and relationship drafts for the literal name, parent, birth, and declarant fields.

## Conversion Confidence And QA Concern

Identity creation and merge work should wait because the assigned chunk and converted file conflict on several identity-bearing fields, including child names for entries 513-515, mother surname in entry 513, father status/name in entry 514, and father/mother fields in entry 515.

## Uncertainty

These are identity candidates only. Do not merge or create canonical pages from them until proof review against the image resolves the conversion conflict.
