...
conversion_qa_concern: "The original source PNG is not present under raw/sources in this checkout. The assigned chunk and staged crop assets support the Pulgar/Arriagada row, while the current converted Markdown records a different Burgos/de la Cruz entry 172."
