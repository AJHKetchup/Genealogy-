...
This worker could not complete fresh full-page original-image certification because the referenced PNG is not present in `raw/sources/` in this checkout. This note compares the assigned chunk, the current converted Markdown, the chunk manifest, and existing staged crop assets.
...
The staged crops `research/_staging/conversion-review-assets/chunk-b8f4f0490a36-entry-172-parent-fields-postconv-evidence-extraction-20260529000036877.png` and `research/_staging/conversion-review-assets/chunk-b8f4f0490a36-entry-172-parent-fields-bottom-postconv-evidence-extraction-20260529000036877.png` visibly support the Pulgar/Arriagada parent and informant fields at crop level, including `Jose del Carmen Pulgar`, `Juana Arriagada de Pulgar`, and `Ernesto Herrera L.`. They do not make the trailing suffix after `Pulgar` promotion-ready.
...
Keep all dependent claims, relationships, identity attachments, and wiki updates at `hold_for_conversion_qa` until a worker with the original full-page image available certifies the physical row and proof review accepts the row-control resolution.
