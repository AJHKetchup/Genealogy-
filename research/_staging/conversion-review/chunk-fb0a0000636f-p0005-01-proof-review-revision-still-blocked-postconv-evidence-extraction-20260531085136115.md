...
worker: postconv-evidence-extraction-20260531085136115
...
literal_support: Assigned chunk presents 1979-1970 HABITAT/NFB/Chile Films/CITELCO work-history text; conversion-job page-markdown/page-0005.md presents competing 1999-1997 consulting text.
promotion_recommendation: hold_for_conversion_qa
---

# Conversion Review Note: Page 5 Still Blocked

This proof-review revision cannot be made promotion-ready by evidence extraction alone. The assigned chunk and the conversion job page Markdown disagree about the contents of page 5.
...
- The observed converted file hash and chunk hash do not match recorded metadata.
