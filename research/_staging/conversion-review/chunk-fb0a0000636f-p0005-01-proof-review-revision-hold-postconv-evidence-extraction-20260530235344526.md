...
worker: postconv-evidence-extraction-20260530235252945
...
Proof review requested source-prep/conversion QA before promotion. This revision did not edit raw sources, converted Markdown, chunks, page Markdown, or canonical files.
...
- `page-images/page-0005.jpg` and `extracted-images/page-0005.jpg` were not present in the conversion job directory during this pass.
