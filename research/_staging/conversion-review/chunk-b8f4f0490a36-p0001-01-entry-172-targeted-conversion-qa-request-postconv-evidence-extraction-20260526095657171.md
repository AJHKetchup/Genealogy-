...
- Held source packet: `research/_staging/source-packets/chunk-b8f4f0490a36-p0001-01-entry-172-pulgar-arriagada-held-postconv-evidence-extraction-20260526095657171.md`

## Current Extraction Finding

Image review during evidence extraction supports the Pulgar/Arriagada row as entry 172, matching the current chunk. The current converted Markdown conflicts by recording a Burgos/de la Cruz row for entry 172. The father field appears readable as `Jose del Carmen Pulgar`, but this extraction does not certify whether there is a final `S.` or uncertain trailing mark.
