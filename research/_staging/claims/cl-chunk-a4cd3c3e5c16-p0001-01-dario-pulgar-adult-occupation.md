...
tags: [claim, staging, occupation, pulgar]
---

# Atomic Claim: Dario Pulgar Occupation or Calling

## Claim

Dario Pulgar's profession, occupation, or calling was listed as `Medical`.
...
The term `Medical` is transcribed literally and is not normalized to physician, doctor, or another occupation without corroboration.
