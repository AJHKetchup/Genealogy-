...
predicate: born
object: "1889-07-23 at 10:00 a.m.; place not transcribed"
...
```text
Fecha. El mismo veinte tres de mil ochocientos ochenta i nueve, a las diez de la mañana.
Lugar.
```

## Conversion Confidence / QA Concern

Medium-high for date/time. The place field is blank in the conversion.

## Uncertainty

`El mismo` refers to the registration date, 23 July 1889.
