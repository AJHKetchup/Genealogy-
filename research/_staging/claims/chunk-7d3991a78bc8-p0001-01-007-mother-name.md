...
- Literal support: source-image reread gives `Nombre de la madre: Juana Arriagada de Pulgar`.
- Conversion confidence/QA concern: assigned derivative gives `Amelia de la Maza`.
- Uncertainty: low for the visible mother name; promotion remains held until conversion QA.
