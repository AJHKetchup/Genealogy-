...
conversion_qa_concern: "Assigned chunk names Juana Arriagada de Pulgar; converted Markdown names Concepcion de la Cruz as mother for entry 172; source image is unavailable for direct row-control QA."
uncertainty: "Hold until source-image row control is certified."
promotion_recommendation: hold_for_conversion_qa
---

# Atomic Claim: Recorded Mother
