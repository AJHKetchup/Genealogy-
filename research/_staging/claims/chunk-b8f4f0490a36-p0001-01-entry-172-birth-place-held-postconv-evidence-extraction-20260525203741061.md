...
- Conversion confidence/QA concern: low; the assigned converted Markdown gives a different entry-172 row.
- Uncertainty: targeted conversion QA must confirm the Pulgar/Arriagada row.
