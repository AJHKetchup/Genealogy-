...
predicate: birth_date_time
object: "22 June 1889, 4:20 a.m."
...
# Atomic Claim: Entry 513 Birth Date And Time

## Literal Support

```text
Fecha. Junio veinte i dos de mil ochocientos ochenta i nueve, a las cuatro i veinte de la mañana
```

## Conversion Confidence / QA Concern

High within the converted chunk; proof review against the image remains required.
