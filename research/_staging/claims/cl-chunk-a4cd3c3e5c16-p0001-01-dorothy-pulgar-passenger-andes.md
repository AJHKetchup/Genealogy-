...
# Atomic Claim: Dorothy Pulgar Passenger on Andes

## Claim

Dorothy Pulgar traveled first class on the Royal Mail Lines ship `ANDES`, departing Southampton on 7 August 1953 for South America, with Buenos Aires as the contracted landing port.
...
Low for promotion pending page-image reread; the surname is carried by ditto mark from the preceding `PULGAR Dario` row.

## Uncertainty

The row does not state a relationship between Dorothy and either Dario Pulgar entry.
