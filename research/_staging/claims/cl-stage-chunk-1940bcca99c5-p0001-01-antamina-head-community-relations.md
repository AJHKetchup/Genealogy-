...
# Atomic Claim: Dario Arturo Pulgar Antamina Head Community Relations
...
- Chunk/page reference: `CHUNK-1940bcca99c5-P0001-01`, assigned page 1; page metadata says CV page 4.

## Conversion Confidence And QA Concern

Reading confidence is medium-high. The date, organization, place, and role headings are clear, but should be compared with the page image before canonical promotion.

## Uncertainty

The page body does not name Dario Arturo Pulgar; the subject is attributed from the source title and CV context.
