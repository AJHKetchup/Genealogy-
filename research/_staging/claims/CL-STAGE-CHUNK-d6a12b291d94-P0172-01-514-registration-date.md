...
page_reference: page 172; entry 514
confidence: 8.0
promotion_recommendation: promote_after_review
---

# Atomic Claim: Entry 514 Registration Date

## Literal Support

```text
514 | Julio veintidos de mil ochocientos ochenta i nueve
```

## Conversion Confidence / QA Concern

High within the converted chunk; proof review against the source image remains required before promotion.
