...
The image-reviewed row and assigned chunk support this birthplace. The current converted Markdown conflicts on row identity.

## Uncertainty

Low uncertainty for the recorded place; proof review is required before canonical promotion.
