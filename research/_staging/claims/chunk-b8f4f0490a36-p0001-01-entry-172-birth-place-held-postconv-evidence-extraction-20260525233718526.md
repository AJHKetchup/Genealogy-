...
- Conversion confidence/QA concern: low; the current converted Markdown records a different entry 172 birth place, `En esta`.
- Uncertainty: row-control QA must resolve the entry-172 conflict before this birth-place fact can be promoted.
