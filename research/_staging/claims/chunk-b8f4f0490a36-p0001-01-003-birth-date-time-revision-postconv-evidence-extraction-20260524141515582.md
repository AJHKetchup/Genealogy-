...
- Conversion confidence/QA concern: source image and assigned chunk support this birth date/time; the assigned converted Markdown gives a different date and row for entry 172.
- Uncertainty: low for the image/chunk reading; high for promotion readiness until conversion QA. The object normalizes the literal Spanish date and 3:00 p.m. time.
