...
Nombre de la madre.
Carmen Leiva
Nac. Chilena Prof. Costurera
Domicilio. Calle Panquehue
```

## Conversion Confidence / QA Concern

Low. The entry 515 surname readings conflict with direct image review; the mother field is not reliable in the assigned chunk.

## Uncertainty

Re-transcribe the mother field from the original image.
