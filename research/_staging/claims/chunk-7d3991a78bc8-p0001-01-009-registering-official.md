...
type: claim
status: draft
claim_type: registering_official
subject: "Jose del Carmen Segundo Pulgar Arriagada"
predicate: "birth registration was signed by"
object: "Emilio Riquelme V."
...
# Claim: Registering Official

- Literal support: source-image reread gives official/signature `Emilio Riquelme V.`.
- Conversion confidence/QA concern: assigned derivative gives `Camilo Luis osorio`.
- Uncertainty: low for the visible official signature; promotion remains held until conversion QA.
