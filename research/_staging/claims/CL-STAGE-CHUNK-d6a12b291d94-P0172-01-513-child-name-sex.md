...
object: "Registered in birth entry 513; sex recorded as Masculino"
...
```text
Nombre. Tulio Cesar Luis Jose
Sexo Masculino
```

## Conversion Confidence / QA Concern

High within the converted chunk; Spanish diacritics are absent in the register transcription and should not be silently modernized in literal support.
