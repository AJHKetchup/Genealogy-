...
The registration date is the same in both derivative row readings, but this claim is staged from the image-reviewed Pulgar/Arriagada row.

## Uncertainty

No registration-date uncertainty is staged.
