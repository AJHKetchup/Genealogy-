...
- Literal support: source-image reread gives `Lugar: Calle de Valdivia`.
- Conversion confidence/QA concern: assigned derivative gives `En esta Subdelegacion` for the conflicting Bunster/de la Maza row.
- Uncertainty: low for the visible place; promotion remains held until conversion QA.
