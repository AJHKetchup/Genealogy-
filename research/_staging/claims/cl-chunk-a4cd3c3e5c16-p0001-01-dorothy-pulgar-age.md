...
tags: [claim, staging, age, pulgar]
---

# Atomic Claim: Dorothy Pulgar Age

## Claim

Dorothy Pulgar was listed as age 49 on the 7 August 1953 passenger list.
...
Low for promotion. The age appears in the adult female accompanied-by-spouse column in the conversion, with a red annotation transcribed as `92`; page-image reread is still required.

## Uncertainty

The `92` annotation is not interpreted as part of the age claim.
