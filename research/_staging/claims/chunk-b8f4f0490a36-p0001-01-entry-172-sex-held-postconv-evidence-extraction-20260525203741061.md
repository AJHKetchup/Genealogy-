...
- Conversion confidence/QA concern: low; the assigned converted Markdown records a different child for entry 172.
- Uncertainty: this claim depends on QA confirming the Pulgar/Arriagada row as the controlling entry.
