...
The current converted Markdown records entry 172 with place `En esta` for a different child. Hold until targeted conversion QA resolves the conflict.

## Uncertainty

The place reading is supported by the assigned chunk and visible row, but should not be promoted until row control is certified.
