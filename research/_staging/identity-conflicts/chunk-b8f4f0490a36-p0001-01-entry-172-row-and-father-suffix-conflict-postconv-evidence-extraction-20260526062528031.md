...
# Identity Conflict: Entry 172 Row And Father Field
...
- Assigned chunk and source image row: child `Jose del Carmen Segundo Pulgar Arriagada`; father begins `Jose del Carmen Pulgar`; mother `Juana Arriagada de Pulgar`; birth 8 March 1888 at 3 p.m.; place `Calle de Valdivia`; informant `Ernesto Herrera L.`
