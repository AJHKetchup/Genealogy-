...
worker: "postconv-evidence-extraction-20260530152132438"
source_packet: "research/_staging/source-packets/sp-chunk-b8f4f0490a36-p0001-01-entry-172-held-postconv-evidence-extraction-20260530152132438.md"
...
conversion_qa_concern: "The original full page image is not available locally, so this worker cannot certify which physical row controls entry 172. The father suffix after Pulgar is not certified."
...
# Conversion Review Note: Entry 172 Held For Full-Image QA

The requested targeted QA cannot be completed to promotion standard in this checkout because the original PNG named in the manifest/source path is absent from `raw/sources`, and the conversion job directory contains only Markdown/work-order files.
...
Required follow-up: restore or provide the original full source image, rerun targeted row-control QA against the image/chunk/converted Markdown/source packet, then rerun proof review before any promotion.
