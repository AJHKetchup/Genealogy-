...
literal_support: Assigned chunk contains HABITAT/NFB/Chile Films/CITELCO work-history text; the aggregate converted file's labeled page-5 section contains PROFONANPE/TVE/Arca/Klohn Crippen/SNC Lavalin text.
conversion_qa_concern: Rendered page image page-0005.jpg is absent locally, aggregate page-5 text disagrees with the assigned chunk, current hashes differ from recorded metadata, and the chunk manifest duplicates page-0005 with different hashes.
promotion_recommendation: hold_for_conversion_qa
---

# Conversion Review Note: CHUNK-fb0a0000636f-P0005-01 Page-Control Hold

The assigned chunk `raw/chunks/ca07263f40-cv-of-dario-arturo-pulga-p0004-0009-cv-of-dario-arturo-pulgar-pages-4-9-codex/page-0005-chunk-01.md` contains work-history entries for HABITAT, National Film Board of Canada, Chile Films, and CITELCO. By contrast, the aggregate converted file's labeled page-5 section contains 1999/1998 entries for PROFONANPE, TVE, Arca Consulting/European Commission, Klohn Crippen Consultants, and SNC Lavalin Agriculture.
