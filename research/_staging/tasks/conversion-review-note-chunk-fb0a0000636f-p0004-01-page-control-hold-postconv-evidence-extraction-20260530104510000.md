...
worker: "postconv-evidence-extraction-20260530104410124"
...
literal_support: "Derivative chunk text preserves 1988-1989 FAO/Ndola, 1988 CIDA/Ethiopia, 1986-1987 WIF/Rome, WIF project countries, and 1982-1985 independent communications consultant entries; current converted page 4 contains 2000 IBRD and 1999-2000 Antamina text."
conversion_confidence: low_for_page_control
conversion_qa_concern: "The assigned chunk, current converted page 4, duplicate chunk manifest records, and prior image-reviewed page-control evidence disagree. The page-4 image was still absent during this revision, so this evidence extraction pass cannot determine which physical page controls the 1982-1989 entries."
...
The staged source packet and atomic claims for Dario Arturo Pulgar's derivative 1982-1989 work-history entries remain blocked for conversion QA.

The assigned chunk currently contains the 1988-1989 FAO/Ndola entry, the 1988 CIDA/Ethiopia entry, the 1986-1987 WIF/Rome entry with project countries, and the 1982-1985 independent communications consultant entry. The current converted Markdown page 4 instead contains 2000 IBRD / Bolivia, Peru and 1999-2000 Antamina / Huarmey, Peru entries, as also recorded by prior proof review. The chunk manifest repeats `CHUNK-fb0a0000636f-P0004-01` for the same path/page with different counts and hashes, and neither manifest hash matches the current on-disk chunk hash.
