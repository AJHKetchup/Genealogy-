...
- Entry 513 child: assigned chunk `Pulgar Amagada / Jose Luis`; assembled converted Markdown `Isolina del Carmen / Jose`.
- Entry 513 birth date/time: assigned chunk `Junio veinte i seis ... a las cuatro i media de la tarde`; assembled converted Markdown `El mismo veinte dos ... a las cuatro de la manana`; image review appears closer to `Junio veinte i dos` and likely `cuatro i media ... tarde`, while the time phrase still needs targeted review.
...
- Entry 514 father: assigned chunk and image `Se ignora`; assembled converted Markdown places `Belisario Riquelme` in the father field.
- Entry 514 witness/place: assigned chunk `Benjamin Utiera` and `Calle Sanegueso`; assembled converted Markdown `Benjamin Utrosa`, `Ignacio Jara`, and `Calle Saneguin`.
