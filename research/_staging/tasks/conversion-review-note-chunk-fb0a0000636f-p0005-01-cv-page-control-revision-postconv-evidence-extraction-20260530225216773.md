...
# Conversion Review Note: CHUNK-fb0a0000636f-P0005-01 Page-Control Revision Hold

Current inspection finds that the assigned chunk and the current aggregate converted file both contain work-history entries for HABITAT, National Film Board of Canada, Chile Films, and CITELCO. This differs from earlier staged notes that reported the aggregate converted file as carrying the 1999 consulting sequence.

The conversion job page Markdown still conflicts with those two derivatives. `raw/codex-conversion-jobs/ca07263f40-cv-of-dario-arturo-pulga-p0004-0009-cv-of-dario-arturo-pulgar-pages-4-9/page-markdown/page-0005.md` begins with 1999 PROFONANPE and Television Trust for the Environment entries, then includes Arca Consulting/European Commission, Klohn Crippen Consultants, and SNC Lavalin Agriculture.
...
The expected rendered page image `raw/codex-conversion-jobs/ca07263f40-cv-of-dario-arturo-pulga-p0004-0009-cv-of-dario-arturo-pulgar-pages-4-9/page-images/page-0005.jpg` is not present. Only derivative text files and metadata were inspected; this evidence-extraction task did not run source preparation or document conversion.

No claims from this chunk should be promoted until conversion QA restores or re-renders the authoritative page image, reconciles the page Markdown, aggregate converted file, and chunk manifest, and selects the controlling page-5 transcript. If the HABITAT/NFB/Chile Films/CITELCO transcript survives QA, a separate identity-bridge review should decide whether document-level `Dario Arturo Pulgar` can be attached to any canonical family person.
