...
Run targeted conversion QA against the source image, assigned converted Markdown, current chunk, and this source packet for register page 58, entry 172.
...
- After QA, rerun proof review for the child identity, birth claims, father and mother claims, parent-child relationships, and any parent-candidate merge or Dario-line comparison.
