...
- Entry 513 child: assigned chunk has `Pulgar Amagada / Jose Luis`; converted file has `Tulio Cesar Luis Jose`. The image supports a `Pulgar Ama...` surname line and a given-name line beginning `Jose ...`, but does not securely support `Jose Luis`; the name should remain held.
