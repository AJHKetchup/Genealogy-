...
worker: postconv-identity-analysis-20260524180306741
...
- No canonical or reviewed context found here supports `Pulgara` as a separate surname/person for this article.
...
- Local staged context includes `Dario J. Pulgar Arriagada` in a 1918 medical-surgeon title list and `Dario Pulgar-Arriagada` in medical/service contexts.
