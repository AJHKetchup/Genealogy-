...
worker: postconv-identity-analysis-20260525174200775
...
- This is not a spelling or name-variant issue. The competing readings disagree on child name, parents, birth date, birth place, informant, locality, and family relevance.
...
- Do not silently equate this name with any other Juana candidate without proof review.
...
| `Dario/Dario Pulgar Arriagada` | Existing wiki context includes `Dario Pulgar Arriagada` in a 2000 Chiguayante expropriation notice; other staged notes discuss Dario name-form variants. | No initial, occupation, chronology, residence, property, or relationship bridge appears here. | 0.01 |
