...
worker: postconv-identity-analysis-20260526140101459
...
- This is a material row-level derivative conflict. The staged source packet and current chunk support a Pulgar/Arriagada entry 172, while the current converted Markdown describes a Burgos/de la Cruz entry 172.
...
| evidence_quality | 0.66 | Chunk plus image-reviewed source packet are useful local evidence, but derivative disagreement remains unresolved. |
...
- The surrounding entries in the converted Markdown also diverge from the chunk's page-58 and page-59 entries, suggesting a broader row/page-source mismatch rather than a simple spelling issue.
- No canonical Burgos/de la Cruz person page was identified in the targeted local wiki context for this task.
...
- Existing local identity analyses preserve separate Dario Jose / Dario J. / Pulgar Arriagada clusters in medical, photograph, passenger, and legal-notice contexts.
...
- A 1888 birth row, separate Dario Jose/Dario J. clusters, and a 2000 Darío Pulgar Arriagada expropriation stub may involve different generations or same-surname relatives; no bridge is present here.
...
Keep the staged conflict draft and all dependent identity/relationship claims at `hold_for_conversion_qa`. Do not merge people, rename canonical pages, promote facts, or attach entry-172 evidence to Dario Arturo Pulgar-Smith, Dario Arturo Pulgar, Dario Jose Pulgar-Arriagada, Darío Pulgar Arriagada, Jose del Carmen Pulgar, Juana Arriagada de Pulgar, or Juana de Dios Amagada de Pulgar.
