...
- The assigned chunk and directly inspected source image support entry 172 as a Pulgar/Arriagada birth registration, while the converted Markdown file's entry 172 is an unrelated Jose Miguel / Bunster / de la Maza derivative row. This is a material same-entry conversion conflict.
...
## Hypothesis 2: Entry 172 Is The Bunster/de la Maza Derivative Row
...
- The converted Markdown file's entry 172 does not name the Pulgar/Arriagada child. It gives a different child and parents: `Jose Miguel`, `Oswaldo Bunster`, and `Amelia de la Maza`.
...
- Do not create or promote Bunster or de la Maza people from this entry unless later conversion QA proves the current source-image assignment is wrong.
...
- Duplicate-person risk: high if Bunster/de la Maza people are promoted from the mismatched conversion; moderate if Jose/Juana candidates are merged across Pulgar entries without proof review.
...
| 3 | Entry 172 is the Bunster/de la Maza derivative row | 0.05 | Treat as conversion mismatch unless QA proves a source-assignment error. |
