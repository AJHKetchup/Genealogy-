...
worker: postconv-identity-analysis-20260526235734395
...
3. No same-person, duplicate-person, or lineage bridge to any Dario-line person is supported by this entry. The row does not name `Dario Arturo Pulgar-Smith`, document-level `Dario Arturo Pulgar`, `Dario Jose Pulgar-Arriagada`, `Darío J. Pulgar Arriagada`, or `Darío Pulgar Arriagada`.
4. `Juana Arriagada de Pulgar` and `Juana de Dios Amagada de Pulgar` remain separate Jose/Juana parent candidates. This entry names only `Juana Arriagada de Pulgar`; existing wiki context separately has `Juana de Dios Amagada de Pulgar` as a parent candidate for `Tulio Cesar Luis Jose`.
5. Canonical promotion should wait for proof review acceptance of the targeted QA-controlled row resolution and a decision about whether the converted Markdown conflict is retained as a known derivative error or corrected by a separate conversion-control process.

## Literal Source Readings

From the staged source packet and targeted QA note, the certified physical-row reading is:
...
The assigned chunk agrees with this row structure but renders the father as `Jose del Carmen Pulgar S.`. The current converted Markdown instead gives entry `172` as `Jose Miguel`, father `Oswaldo Burgos`, mother `Concepcion de la Cruz`, born `El seis de Abril de mil ochocientos ochenta i ocho, a las diez de la noche`.

## Hypotheses And Evidence

### H1: Physical Entry 172 Is The Pulgar/Arriagada Row

Evidence supporting: the staged conflict draft, source packet, assigned chunk, and targeted conversion QA note all identify the controlling physical row as entry `172` on register page 58 for `Jose del Carmen Segundo Pulgar Arriagada`, child of `Jose del Carmen Pulgar` and `Juana Arriagada de Pulgar`.
...
Scores: identity confidence 0.86; conflict severity 0.95; evidence quality 0.88; conversion confidence 0.72 because of the stale converted Markdown; claim probability 0.84; relevance high 0.95; canonical readiness hold pending proof review.
...
Scores: identity confidence 0.18; conflict severity 0.95; evidence quality 0.35; conversion confidence 0.20; claim probability 0.16; relevance low for Pulgar-line work 0.10; canonical readiness not ready.

### H3: `Jose del Carmen Segundo Pulgar Arriagada` Matches The Existing Canonical Stub Of That Name

Evidence supporting: the existing wiki page `wiki/people/jose-del-carmen-segundo-pulgar-arriagada.md` already carries Entry 172 evidence snapshots for the same child name, birth date/time, birthplace, sex, and probable mother `Juana Arriagada de Pulgar`.

Evidence against or limiting: those wiki facts derive from the same Entry 172 cluster and therefore cannot independently resolve the conversion mismatch. They support same-cluster alignment, not external corroboration.

Scores: identity confidence 0.82; conflict severity 0.50; evidence quality 0.76; conversion confidence 0.72; claim probability 0.80; relevance high 0.94; canonical readiness hold for row-control proof review.

### H4: `Jose del Carmen Pulgar` / `Jose del Carmen Pulgar S.` Is The Father Candidate For This Entry

Evidence supporting: the targeted QA certifies father `Jose del Carmen Pulgar`; the assigned chunk reads `Jose del Carmen Pulgar S.`. The existing wiki page `wiki/people/jose-del-carmen-pulgar.md` is a local parent-candidate page, but its current visible evidence snapshot concerns a separate child, `Tulio Cesar Luis Jose`.
...
Scores: identity confidence 0.66 for the bounded father reading; conflict severity 0.60; evidence quality 0.78; conversion confidence 0.70; claim probability 0.74 for `Jose del Carmen Pulgar` as recorded father; relevance high 0.88; canonical readiness hold for father-field proof review.
...
Scores: identity confidence 0.84; conflict severity 0.35; evidence quality 0.84; conversion confidence 0.76; claim probability 0.86; relevance high 0.92; canonical readiness scoped hold until row-control proof review accepts the QA note.
...
Scores: identity confidence 0.20; conflict severity 0.70 if merged prematurely; evidence quality 0.25; conversion confidence 0.60 for this entry only; claim probability 0.18; relevance moderate 0.55; canonical readiness not ready.

### H7: Entry 172 Bridges To `Dario Arturo Pulgar-Smith` Or Document-Level `Dario Arturo Pulgar`

Evidence supporting: existing wiki context has canonical `Dario Arturo Pulgar-Smith` as a family-supplied maternal-grandfather profile, and staged CV materials elsewhere use document-level `Dario Arturo Pulgar`. The Pulgar surname makes the entry a possible future lineage lead.

Evidence against or limiting: this birth entry names `Jose del Carmen Segundo Pulgar Arriagada`, not Dario, Arturo, Smith, Pulgar-Smith, Alexander John Heinz, a spouse, child, or descendant of a Dario candidate. Existing Dario Arturo CV proof-review notes require a separate identity bridge before attaching facts to `Dario Arturo Pulgar-Smith`.

Scores: identity confidence 0.08; conflict severity 0.88 if attached prematurely; evidence quality 0.20 for Dario comparison; conversion confidence 0.72 for the row only; claim probability 0.06; relevance low-to-moderate as a future lead 0.35; canonical readiness not ready.

### H8: Entry 172 Bridges To `Dario Jose Pulgar-Arriagada`, `Darío J. Pulgar Arriagada`, Or `Darío/Dario Pulgar Arriagada`

Evidence supporting: local context contains Pulgar-Arriagada/Dario clusters, including canonical `wiki/people/dar-o-pulgar-arriagada.md` with a 2000 expropriation-event evidence snapshot and staged materials for `Dario Jose Pulgar-Arriagada` or `Darío J. Pulgar Arriagada`.

Evidence against or limiting: this entry names a different given-name cluster, `Jose del Carmen Segundo`, and supplies no medical, Geneva, public-office, residence, spouse, child, chronology, or parent bridge to any Dario candidate. A person born in 1888 as Jose del Carmen Segundo cannot be treated as a Dario identity by surname pattern alone.

Scores: identity confidence 0.07; conflict severity 0.90 if merged prematurely; evidence quality 0.18 for Dario comparison; conversion confidence 0.72 for the row only; claim probability 0.05; relevance low-to-moderate as anti-conflation context 0.40; canonical readiness not ready.
...
Send the targeted conversion QA note and this staged conflict analysis to proof review for a scoped decision: accept the physical-row control that entry `172` is the Pulgar/Arriagada row, preserve the converted Markdown Burgos/de la Cruz row as a derivative conversion mismatch, and certify the father field only as `Jose del Carmen Pulgar` unless the proof reviewer can visibly accept the suffix. After that, rerun promotion only for narrowly scoped Entry 172 claims and relationships; do not merge Jose/Juana candidates or attach any Dario-line identity without a separate identity-bridge proof review using direct bridging evidence.
