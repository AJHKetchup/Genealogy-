...
worker: postconv-identity-analysis-20260528173924316
...
1. The exact staged draft reviewed here reports a material row-level conversion conflict: the current converted Markdown records entry `172` as `Jose Miguel`, child of `Oswaldo Burgos` and `Concepcion de la Cruz`, while the image-reviewed row-control packet identifies physical row `172` as `Jose del Carmen Segundo Pulgar Arriagada`, child of `Jose del Carmen Pulgar` and `Juana Arriagada de Pulgar`.
...
3. This row does not name Dario, Arturo, Smith, `Dario Arturo Pulgar-Smith`, `Dario Arturo Pulgar`, `Dario Jose Pulgar-Arriagada`, or `Dario/Dario Pulgar Arriagada`. Any Dario-line attachment requires a separate identity-bridge proof review.
4. Existing canonical wiki pages already contain generated or family-supplied Pulgar context. This note does not merge people, rename pages, promote facts, or edit canonical pages.
...
- Existing canonical wiki pages checked: `wiki/people/dario-arturo-pulgar-smith.md`, `wiki/people/dar-o-pulgar-arriagada.md`, `wiki/people/jose-del-carmen-segundo-pulgar-arriagada.md`, `wiki/people/jose-del-carmen-pulgar.md`, `wiki/people/juana-arriagada-de-pulgar.md`, `wiki/people/juana-de-dios-amagada-de-pulgar.md`, `wiki/people/birth-registration-entry-172-for-jose-del-carmen-segundo-pulgar-arriagada.md`, and `wiki/relationships/dario-arturo-pulgar-smith-maternal-grandfather-of-alexander-john-heinz.md`.
...
The assigned chunk agrees in substance but transcribes the father field as `Jose del Carmen Pulgar S.`. Interpretation kept separate: only the base father name is certified by the targeted review.

The current converted Markdown instead reads entry `172` as `Jose Miguel`, father `Oswaldo Burgos`, mother `Concepcion de la Cruz`, born 6 April 1888 at about 10 p.m. in `En esta`. Interpretation kept separate: this is a derivative conversion conflict, not a source-controlled identity variant.
...
- The 1888 row does not give the father's age, birth date, parents, marriage record, or signature.
...
- No uncertainty was flagged for this mother-name reading in the targeted review note.
...
- Existing canonical `wiki/people/dar-o-pulgar-arriagada.md` preserves a `Dario Pulgar Arriagada` expropriation-event cluster dated 2000-12-05.
...
- Chronology conflict: no internal chronology conflict in the 1888 row; chronology risk becomes high only if attached to later Dario/Dario Pulgar Arriagada or Dario Arturo clusters without direct bridge evidence.
