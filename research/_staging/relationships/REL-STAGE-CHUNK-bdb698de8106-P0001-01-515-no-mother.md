...
# Negative Evidence Note: Entry 515 Mother Not Stated
...
Medium. The converted table shows the mother fields blank.

## Uncertainty

This is not proof that the mother was unknown in all records; it only documents that no mother name is transcribed in this entry.
