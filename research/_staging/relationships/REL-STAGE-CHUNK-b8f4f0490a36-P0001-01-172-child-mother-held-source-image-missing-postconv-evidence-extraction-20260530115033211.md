...
conversion_qa_concern: "Assigned chunk supports this mother candidate, but current converted Markdown gives a conflicting mother and the source image is unavailable for row-control QA."
uncertainty: "Relationship is conditional on later image-controlled row certification."
