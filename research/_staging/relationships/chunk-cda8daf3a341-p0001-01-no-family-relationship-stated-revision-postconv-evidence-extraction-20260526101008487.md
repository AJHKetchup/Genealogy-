...
conversion_qa_concern: Negative relationship evidence is limited to the converted page and does not evaluate external ICRC/archive metadata; the assigned source image remains absent for direct reread.
