...
child: Isolina del Carmen Jose
parents: [Jose del Carmen Pulgar, Juana de Dios Amador de Pulgar]
...
```text
Nombre. Isolina del Carmen José
...
Parent fields are strong, but the child's registered name/sex needs image review before tree linkage.

## Uncertainty

Review child identity and name parsing before promotion.
