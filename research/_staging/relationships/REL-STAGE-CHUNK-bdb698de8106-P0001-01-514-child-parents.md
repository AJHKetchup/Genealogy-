...
# Relationship Candidate: Entry 514 Child And Parents

## Literal Support

```text
Nombre. Riquelme Juan Teodoro
Nombre del padre. Belisario Riquelme
Nombre de la madre. Mercedes Riquelme
```

## Conversion Confidence / QA Concern

Medium-high. Father's supporting details are blank, but the named father field is direct.

## Uncertainty

Mercedes Riquelme is also described as wife of Juan Soler; that is a separate identity/spouse clue and should not override the named father field without review.
