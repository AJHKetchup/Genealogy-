...
parents:
  ...
  - Juana de Dios Amador de Pulgar in converted transcript; surname unresolved pending conversion QA
...
Low for a tree link. The father field is family-relevant, but the child identity and mother surname remain unstable under proof-review revision context.

## Uncertainty

This draft preserves the possible relationship for later review. It is not a canonical parent-child attachment.
