...
conversion_qa_concern: "Image review and assigned chunk support the Pulgar/Arriagada row for physical entry 172; current converted Markdown records a different Burgos/de la Cruz entry 172. Father is certified only as Jose del Carmen Pulgar, with any suffix unresolved."
uncertainty: "Low for row control and the core Pulgar/Arriagada birth details from image-reviewed evidence; moderate for any terminal mark or suffix after Pulgar; high for canonical promotion until conversion-control resolves the converted Markdown conflict."
...
Direct review of the original page image shows entry `172` as the middle row on left page/register page 58. Reading across that row supports:
