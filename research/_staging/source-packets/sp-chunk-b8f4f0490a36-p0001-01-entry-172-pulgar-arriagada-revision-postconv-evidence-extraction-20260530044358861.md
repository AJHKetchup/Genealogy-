...
conversion_qa_concern: "The current converted Markdown records a different Burgos/de la Cruz entry 172. The original source PNG was not present in raw/sources for this worker, so the Pulgar/Arriagada extraction remains staged only pending original-image QA and proof review."
uncertainty: "High for promotion readiness because the derivative row-control conflict remains unresolved in canonical conversion artifacts. Medium for any suffix after Jose del Carmen Pulgar. Low for family relevance if the Pulgar/Arriagada row is confirmed as controlling."
promotion_recommendation: hold_for_conversion_qa
---

# Source Packet: Entry 172 Pulgar/Arriagada Birth Registration

This packet stages family-relevant evidence from the assigned chunk while preserving the conflict between derivative transcripts.
...
Existing staged crop assets under `research/_staging/conversion-review-assets/` support the base parent and informant fields for the Pulgar/Arriagada row. They do not certify a trailing suffix after `Pulgar`.
