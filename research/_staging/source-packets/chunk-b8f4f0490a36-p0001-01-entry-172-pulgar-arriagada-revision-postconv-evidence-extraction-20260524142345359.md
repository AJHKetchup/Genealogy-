...
worker: postconv-evidence-extraction-20260524142345359
...
conversion_qa_concern: "The source image and assigned chunk support the Pulgar/Arriagada entry 172 row, while the assigned converted Markdown transcribes entry 172 as a different Gomez/de la Maza row. The father's final name mark or suffix remains unresolved."
uncertainty: "Low for the row identity as Pulgar/Arriagada in the source image and assigned chunk; moderate for the father's exact suffix and exact residence spelling; high for canonical readiness until conversion QA reconciles or supersedes the converted Markdown."
...
The assigned converted Markdown records entry 172 as `José Francisco`, father `Oswaldo Gomez`, mother `Rosario de la Cruz de la Maza`, born in `Pellin`. This is a row-level conflict, not a spelling variant.
