...
Do not promote the father's possible suffix `S.` from this packet. Do not use this source alone to merge this child, father, mother, or parental pair into any existing Pulgar or Arriagada identity cluster. Canonical promotion still requires proof review of the revised staged claims and relationship candidates.
