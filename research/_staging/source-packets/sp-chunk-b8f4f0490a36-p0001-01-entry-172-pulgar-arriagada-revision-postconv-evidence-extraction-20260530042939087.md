...
worker: "postconv-evidence-extraction-20260530042939087"
...
conversion_confidence: "staged_crop_and_assigned_chunk_reviewed_original_source_missing"
conversion_qa_concern: "Current converted Markdown records a different Burgos/de la Cruz entry 172. The original source PNG was not present for this worker, so preserve the Pulgar/Arriagada evidence as staged but do not promote until original-image QA and proof review."
uncertainty: "High for promotion readiness because row-control conflict remains unresolved at the derivative layer. Medium for any suffix after Jose del Carmen Pulgar. Low for family relevance if the Pulgar/Arriagada row is confirmed as controlling."
promotion_recommendation: hold_for_conversion_qa
---

# Source Packet: Entry 172 Pulgar/Arriagada Birth Registration

This packet stages family-relevant evidence for the Pulgar/Arriagada row while preserving the conflict between derivative transcripts.
...
Existing staged crop assets under `research/_staging/conversion-review-assets/` support the base parent/informant fields for the Pulgar row. They do not certify a trailing suffix after `Pulgar`.
