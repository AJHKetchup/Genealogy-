...
conversion_qa_concern: "Direct source-image review and assigned chunk support the Pulgar/Arriagada row for physical entry 172, while current converted Markdown records a Burgos/de la Cruz entry. Father field is certified only as Jose del Carmen Pulgar; possible terminal suffix remains unresolved."
uncertainty: "Low for row control and central event fields; moderate for any suffix after the father surname Pulgar; high for canonical promotion until conversion-control reconciles the derivative Markdown conflict."
promotion_recommendation: hold_for_conversion_qa
---

# Source Packet: Entry 172 Pulgar/Arriagada Birth Registration

This packet stages family-relevant evidence for `Jose del Carmen Segundo Pulgar Arriagada` from physical row `172` of register page 58.
...
Image review in this pass confirms the controlling physical row is the Pulgar/Arriagada row. The father field is visible to `Jose del Carmen Pulgar`; a possible terminal suffix or mark is not promoted from this extraction.
...
Do not promote this packet, its claims, relationship candidates, identity conclusions, or any wiki update until conversion-control resolves or supersedes the converted Markdown conflict and proof review is rerun.
