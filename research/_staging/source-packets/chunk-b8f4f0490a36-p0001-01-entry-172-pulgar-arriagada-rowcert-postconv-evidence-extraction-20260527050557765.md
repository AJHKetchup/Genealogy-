...
conversion_qa_concern: "Original image review and the assigned chunk identify physical row 172 as the Pulgar/Arriagada birth registration. Current converted Markdown instead records a Burgos/de la Cruz entry for entry 172. Father field is certified only as Jose del Carmen Pulgar; any terminal suffix or mark after Pulgar remains unresolved."
uncertainty: "Low for physical row control, child name, mother name, birth date/time/place, registration date, and informant identity; moderate for father's possible terminal suffix; high for canonical promotion because derivative Markdown still conflicts."
