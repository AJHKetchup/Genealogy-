...
worker: "postconv-evidence-extraction-20260528004757216"
...
conversion_qa_concern: "Original image certifies physical row 172 as the Pulgar/Arriagada row; current converted Markdown gives a conflicting Burgos/de la Cruz row."
uncertainty: "Low for row control and main Pulgar/Arriagada birth facts; moderate for any terminal suffix after the father's surname Pulgar."
...
This birth registration directly supports the Pulgar/Arriagada family narrative by recording a male child's birth, both stated parents, parent domicile, and the compareciente who was present at the birth.
