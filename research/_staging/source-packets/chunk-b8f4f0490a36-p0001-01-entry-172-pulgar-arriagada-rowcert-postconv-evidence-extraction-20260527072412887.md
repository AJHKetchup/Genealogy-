...
conversion_qa_concern: "The original source image and assigned chunk support the Pulgar/Arriagada row for physical entry 172; the current converted Markdown records a different Burgos/de la Cruz entry 172. Father field is certified only as Jose del Carmen Pulgar, with any terminal suffix unresolved."
uncertainty: "Low for row control, child name, birth details, registration date, and mother name from the image-reviewed row; moderate for any suffix after the father surname Pulgar; high for canonical promotion until conversion-control reconciles the converted Markdown conflict."
