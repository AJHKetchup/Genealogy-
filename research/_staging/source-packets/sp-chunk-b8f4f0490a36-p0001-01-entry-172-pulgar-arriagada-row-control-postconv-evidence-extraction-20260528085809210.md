...
conversion_qa_concern: "Original page image confirms physical row 172 is the Pulgar/Arriagada row; current converted Markdown gives a conflicting Burgos/de la Cruz row for entry 172."
uncertainty: "Low for physical row control and main birth facts; moderate for any terminal suffix or mark after the father's surname Pulgar."
...
This birth registration directly supports the Pulgar/Arriagada family narrative. It records a male child, his birth date and place, both stated parents, the parents' domicile, and the compareciente who was present at the birth.
...
Direct image review confirms that physical row `172` on register page 58 is the Pulgar/Arriagada row. The image supports:
...
- father, to visible/certified extent: `Jose del Carmen Pulgar`;
- mother: `Juana Arriagada de Pulgar`;
- compareciente: `Ernesto Herrera L.`, present at the birth, age 26, employed, resident at Calle de Valdivia.
...
`promote_after_review`: promote only after proof review accepts the row-control note, the derivative-transcript conflict, and the limited father-field reading. This record does not name Dario and should not be used by itself for a Dario-line identity bridge or merge.
