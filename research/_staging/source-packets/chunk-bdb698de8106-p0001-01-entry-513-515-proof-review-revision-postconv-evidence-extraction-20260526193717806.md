...
Entry 513 is the family-relevant row. The converted/chunk transcript names `Jose del Carmen Pulgar` as father and `Jose del C. Pulgar` as the father/declarant, age forty-seven, agriculturist, domiciled at Calle Colon.
