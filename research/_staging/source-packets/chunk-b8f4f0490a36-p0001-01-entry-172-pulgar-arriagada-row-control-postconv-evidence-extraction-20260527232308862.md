...
The original source image controls this staging pass. On register page 58, physical row `172` is the Pulgar/Arriagada row, not the Burgos/de la Cruz row in the current converted Markdown.
