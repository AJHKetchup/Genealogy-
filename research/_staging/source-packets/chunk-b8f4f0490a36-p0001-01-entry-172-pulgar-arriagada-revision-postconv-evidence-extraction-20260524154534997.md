...
worker: postconv-evidence-extraction-20260524154448207
...
matched_terms:
  - Pulgar
  - Arriagada
literal_support: "The assigned chunk records entry 172 as Jose del Carmen Segundo Pulgar Arriagada, male, registered 7 April 1888, born 8 March 1888 at about 3 p.m. at Calle de Valdivia, with father Jose del Carmen Pulgar S. and mother Juana Arriagada de Pulgar. Direct image review in this pass supports the Pulgar/Arriagada row, while the father-name suffix after Pulgar is not clear enough here for canonical resolution."
conversion_confidence: mixed
conversion_qa_concern: "Material row-level conflict: the assigned converted Markdown transcribes entry 172 as an unrelated Jose Francisco / Oswaldo Gomez / Emilia de la Cruz birth. The assigned chunk and source image support the Pulgar/Arriagada row. Targeted conversion QA must reconcile or supersede the converted Markdown and explicitly record whether the father field reads Jose del Carmen Pulgar, Jose del Carmen Pulgar S., or Jose del Carmen Pulgar [?]."
uncertainty: "Low for the Pulgar/Arriagada row identity in the chunk and image; medium for exact father-name suffix; high for canonical readiness until conversion QA and proof review are complete."
...
Source-image review in this extraction pass supports the controlling row as the Pulgar/Arriagada entry on page 58, entry 172. The father field visibly supports `Jose del Carmen Pulgar`; a final `S.` or other suffix is not clear enough in this extraction pass to settle.

## Derivative Transcript Conflict

The assigned converted Markdown records entry 172 as `José Francisco`, father `Oswaldo Gomez`, mother `Emilia de la Cruz`, born `El veinte i seis de Marzo de mil ochocientos ochenta i ocho, a las diez de la noche`, at `En esta`. That is a material conflict with the assigned chunk and image-reviewed evidence.
