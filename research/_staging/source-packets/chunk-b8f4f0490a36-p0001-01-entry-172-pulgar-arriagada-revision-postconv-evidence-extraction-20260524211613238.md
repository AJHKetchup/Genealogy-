...
uncertainty: "Low for the Pulgar/Arriagada row identity in the current chunk and source image; medium for the exact father-name suffix and source-visible residence spelling; high for canonical readiness until conversion QA and proof review are complete."
