...
conversion_qa_concern: "Original image and assigned chunk support physical row 172 as the Pulgar/Arriagada birth registration. Current converted Markdown records a different Burgos/de la Cruz entry 172. Father field is preserved only as Jose del Carmen Pulgar; any terminal suffix after Pulgar is unresolved."
uncertainty: "Low for physical row control and the core Pulgar/Arriagada row; moderate for the father's terminal suffix; high for promotion because derivative Markdown still conflicts."
...
Do not promote this source packet, claim drafts, relationship candidates, identity merges, or wiki updates until proof review accepts the row-control finding or conversion-control reconciles the derivative Markdown conflict.
