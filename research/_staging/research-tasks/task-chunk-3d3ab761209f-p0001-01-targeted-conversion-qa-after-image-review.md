...
- Entry 513 child: assigned chunk reads `Pulgar Amagada / Jose Luis`; converted Markdown reads `Tulio Cesar Luis Jose`; image review supports a `Pulgar ...` surname line but does not settle the full given-name reading enough for promotion.
...
- Entry 514 witness and street: `Benjamin Utiera` versus `Benjamin Utria`, and `Calle Sanegueso` versus `Calle San Joaquin`, remain conversion-QA readings rather than canonical facts.
