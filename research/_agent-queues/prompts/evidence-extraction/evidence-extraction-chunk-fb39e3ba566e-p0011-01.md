...
- Matched family terms: Dario, Pulgar, chunk, date
- Evidence priority: `100011` (family_relevance:critical, qc:pass,reread-page, matched_terms, blocked_by_conversion_qc)
