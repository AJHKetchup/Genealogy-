...
| `research/_staging/reviews/proof-review-research-staging-relationships-rel-chunk-3d3ab761209f-p0001-01-515-mother-postconv-proof-review-20260522052351947.md` | `research/_staging/relationships/rel-chunk-3d3ab761209f-p0001-01-515-mother.md` | `revise` | Obtain or review a complete image for the lower portion of entry 515, then rerun conversion QA on entry 515. If the visible source confirms `Nombre de la madre / Carmen Ulloa`, revise the staged relationship with an image-supported literal citation; if not, keep the relationship on hold or remove the unsupported mother claim from the staged set. |
| `research/_staging/reviews/proof-review-research-staging-source-packets-chunk-3d3ab761209f-p0001-01-source-packet-postconv-proof-review-20260522045243449.md` | `research/_staging/source-packets/CHUNK-3d3ab761209f-P0001-01-source-packet.md` | `revise` | Revise the staged source packet in a future source-packet/evidence-extraction pass. Align the heading with the image-supported `Los Anjeles, num. 1o de La Laja`; describe record 515 as partially visible unless a complete source image is available; replace stale QA references to `Utiera` and `Sanegueso` with uncertainty that matches the current conversion/image; and limit officer-signature support to what is visible. Rerun proof review after revision before promotion to canonical claims, relationships, wiki people, or wiki families. |
