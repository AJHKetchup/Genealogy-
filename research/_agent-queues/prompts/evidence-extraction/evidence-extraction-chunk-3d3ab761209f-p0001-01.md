...
| `research/_staging/reviews/identity-analysis-conflict-chunk-3d3ab761209f-p0001-01-conversion-conflicts-proof-review.md` | `research/_staging/identity-analysis/identity-analysis-conflict-chunk-3d3ab761209f-p0001-01-conversion-conflicts.md` | `hold` | Keep the staged identity analysis on hold. The next action is targeted conversion QA against the page image for entry 513 child full name, entry 513 mother surname and birth time, entry 514 child surname/place/witness/father field, and entry 515 lower-row completeness. After QA, run a focused identity proof review before any canonical merge, relationship promotion, or Dario/Pulgar lineage attachment. |
