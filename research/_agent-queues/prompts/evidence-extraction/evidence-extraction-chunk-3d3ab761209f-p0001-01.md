...
| `research/_staging/reviews/identity-analysis-chunk-3d3ab761209f-p0001-01-entry-513-image-reviewed-conflict-note-postconv-evidence-extraction-20260527200921254-proof-review-20260527215757431.md` | `research/_staging/identity-analysis/identity-analysis-chunk-3d3ab761209f-p0001-01-entry-513-image-reviewed-conflict-note-postconv-evidence-extraction-20260527200921254.md` | `hold` | Send entry 513 for targeted conversion QA against the source image, asking the reviewer to double-check the child surname, given-name order, birth date/time, mother surname, and official signature. After that certification, restage atomic claims for the child identity, birth event, father-child relationship, and mother-child relationship for separate proof review. |
