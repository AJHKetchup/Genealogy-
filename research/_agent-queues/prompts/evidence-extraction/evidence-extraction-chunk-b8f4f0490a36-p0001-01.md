...
| `research/_staging/reviews/chunk-b8f4f0490a36-p0001-01-entry-172-identity-analysis-proof-review-postconv-proof-review-20260525191245796.md` | `research/_staging/identity-analysis/identity-analysis-chunk-b8f4f0490a36-p0001-01-entry-172-conversion-conflict-revision-postconv-identity-researcher-20260525093246706.md` | `hold_for_conversion_qa` | Create or route to targeted conversion QA for the assigned converted Markdown, chunk, source packet, and source image. The QA output should explicitly decide the controlling entry 172 transcription and certify the father field as `Jose del Carmen Pulgar`, `Jose del Carmen Pulgar S.`, or `Jose del Carmen Pulgar [?]`. After that, rerun proof review before any canonical promotion. |
| `research/_staging/reviews/chunk-b8f4f0490a36-p0001-01-entry-172-identity-analysis-proof-review-postconv-proof-review-20260525192202113.md` | `research/_staging/identity-analysis/identity-analysis-chunk-b8f4f0490a36-p0001-01-entry-172-conversion-conflict-revision-postconv-identity-researcher-20260525093246706.md` | `hold_for_conversion_qa` | Run targeted conversion QA against the source image, current converted Markdown, current chunk, and source packet. The QA note should reconcile why the converted file now records a Burgos/de la Cruz row while the chunk and image support a Pulgar/Arriagada row, and should certify the father field only to the extent visible. After QA, revise the stale conflict descriptions and rerun proof review before promotion. |
| `research/_staging/reviews/chunk-b8f4f0490a36-p0001-01-entry-172-identity-analysis-proof-review-postconv-proof-review-20260525194616548.md` | `research/_staging/identity-analysis/identity-analysis-chunk-b8f4f0490a36-p0001-01-entry-172-conversion-conflict-revision-postconv-identity-researcher-20260525122440361.md` | `hold_for_conversion_qa` | Run targeted conversion QA against the source image, current converted Markdown, current chunk, and source packet. The QA note should reconcile why the converted file records a Burgos/de la Cruz row while the chunk and image support a Pulgar/Arriagada row, and it should certify the father field only to the extent visible. After QA, revise the stale conflict descriptions and rerun proof review before promotion. |
| `research/_staging/reviews/chunk-b8f4f0490a36-p0001-01-entry-172-identity-analysis-proof-review-postconv-proof-review-20260525194959896.md` | `research/_staging/identity-analysis/identity-analysis-chunk-b8f4f0490a36-p0001-01-entry-172-conversion-conflict-revision-postconv-identity-researcher-20260525122440361.md` | `hold_for_conversion_qa` | Run targeted conversion QA or correction for entry 172 against the source image, assigned converted Markdown, and chunk. The QA note should certify the controlling row and preserve the father field as `Jose del Carmen Pulgar`, `Jose del Carmen Pulgar S.`, or `Jose del Carmen Pulgar [?]`. After that, rerun proof review for any canonical parent-child claim or parent identity merge. |
