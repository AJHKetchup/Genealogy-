...
- Matched family terms: Arriagada, Birth, Carmen, Entry, Jose, Juan, Juana, Luis, Pulgar, Registration, Riquelme, Segundo, chunk
...
| --- | --- | --- | --- |
| `research/_staging/reviews/proof-review-claim-chunk-b8f4f0490a36-p0001-01-007-mother-attributes-postconv-proof-review-20260522123209997.md` | `research/_staging/claims/chunk-b8f4f0490a36-p0001-01-007-mother-attributes.md` | `promote_after_review` | Promote only the scoped mother-attributes claim: Juana Arriagada de Pulgar was recorded in entry 172 as Chilean, with the literal `Prof` value `Su sexo`, and resident at Calle de Colipí. Keep father-name-dependent claims on hold until the father suffix QA issue is resolved. |
...
| `research/_staging/reviews/proof-review-update-research-staging-claims-chunk-b8f4f0490a36-p0001-01-001-child-birth-name-20260522-image-reread.md` | `research/_staging/claims/chunk-b8f4f0490a36-p0001-01-001-child-birth-name.md` | `ready_after_review` |  type: proof_review_update status: draft role: evidence_extractor task_id: evidence-extraction:CHUNK-b8f4f0490a36-P0001-01 prior_review: "research/_staging/reviews/proof-review-research-staging-claims-chunk-b8f4f0490a36-p0001-01-001-child-birth-name-postconv-proof-review-20260522112919722.md" |
