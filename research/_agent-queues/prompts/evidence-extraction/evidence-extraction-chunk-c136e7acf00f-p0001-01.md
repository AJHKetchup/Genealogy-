...
- Narrative cues: address, occupation, residence, ship
- Evidence priority: `-349` (family_relevance:critical, qc:reread-page, matched_terms, person_linked_narrative_context)
