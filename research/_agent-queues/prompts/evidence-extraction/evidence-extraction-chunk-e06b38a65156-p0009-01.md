...
- Narrative cues: none
- Evidence priority: `1309` (family_relevance:medium, qc:spot-check, matched_terms, proof_review_revision)
...
| --- | --- | --- | --- |
| `research/_staging/reviews/proof-review-research-staging-identity-analysis-identity-analysis-conf-stage-chunk-e6b0e6245b3c-p0009-01-page-image-qa-postconv-proof-review-20260523210045817.md` | `research/_staging/identity-analysis/identity-analysis-conf-stage-chunk-e6b0e6245b3c-p0009-01-page-image-qa.md` | `hold_for_chunk_metadata_reconciliation_and_identity_bridge` | Reconcile `CHUNK-e6b0e6245b3c-P0009-01` versus current `CHUNK-e06b38a65156-P0009-01` metadata across the staged draft, source packet, and chunk manifest. After that, use an identity-bearing CV page or another accepted local source for a separate identity-bridge proof review before promoting page-9 facts to any canonical person page. |
