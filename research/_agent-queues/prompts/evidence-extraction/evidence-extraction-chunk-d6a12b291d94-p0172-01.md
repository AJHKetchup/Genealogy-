...
| `research/_staging/reviews/identity-analysis-cf-stage-chunk-4127185dc97c-p0172-01-conversion-conflicts-proof-review-postconv-proof-review-20260523195634360.md` | `research/_staging/identity-analysis/identity-analysis-cf-stage-chunk-4127185dc97c-p0172-01-conversion-conflicts.md` | `hold` | Keep the staged draft on hold for conversion QA. Reconcile the source packet metadata with the restored `page-0172-chunk-01.md`, then run targeted conversion QA for entry 514 father and entry 515 father/declarant surname. Entry 513 may be advanced only after the metadata mismatch is resolved and a fresh claim extraction is created from the corrected conversion; no Dario, Arturo, Smith, Pulgar-Smith, or Arriagada attachment is supported by this reviewed draft. |
...
| `research/_staging/reviews/identity-analysis-id-stage-chunk-4127185dc97c-p0172-01-person-identity-candidates-proof-review-postconv-proof-review-20260523194714286.md` | `research/_staging/identity-analysis/identity-analysis-id-stage-chunk-4127185dc97c-p0172-01-person-identity-candidates.md` | `hold` | Keep the staged draft and all person/relationship claims from page 172 on `hold_for_conversion_qa`. The next action is targeted conversion QA against the source image for entries 513-515, starting with the chunk/version mismatch (`CHUNK-4127185dc97c-P0172-01` versus `CHUNK-d6a12b291d94-P0172-01`). Then verify entry 513 child name and maternal surname, entry 514 father field, and entry 515 surname/emendation before any proof review attempts canonical identity linkage. |
| `research/_staging/reviews/identity-analysis-id-stage-chunk-4127185dc97c-p0172-01-person-identity-candidates-proof-review-postconv-proof-review-20260523210217837.md` | `research/_staging/identity-analysis/identity-analysis-id-stage-chunk-4127185dc97c-p0172-01-person-identity-candidates.md` | `hold` | Keep the assigned staged draft on `hold_for_conversion_qa`. Reconcile the staged `CHUNK-4127185dc97c-P0172-01` metadata with the current restored `CHUNK-d6a12b291d94-P0172-01` chunk and current converted-file hash. Then perform targeted field-level conversion QA from the restored source image for entry 513 child name and maternal surname, entry 514 father field and Mercedes Riquelme role, and entry 515 Leiva/Neira surname conflict. After those readings are settled, rerun proof review on narrow claims rather than promoting from this identity-candidate draft. |
