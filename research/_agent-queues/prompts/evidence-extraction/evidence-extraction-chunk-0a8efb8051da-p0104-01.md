...
- Matched family terms: Entry, List, Rows, chunk, date, name
- Evidence priority: `101104` (family_relevance:high, qc:reread-page, matched_terms, blocked_by_conversion_qc)
