...
| `research/_staging/reviews/identity-analysis-id-stage-chunk-4127185dc97c-p0172-01-person-identity-candidates-proof-review.md` | `research/_staging/identity-analysis/identity-analysis-id-stage-chunk-4127185dc97c-p0172-01-person-identity-candidates.md` | `hold` | Revise the staged identity-analysis draft after conversion QA reconciles the restored chunk ID/SHA with the cited task ID. Then perform field-level image review for entry 513 child name/surname, Jose father/declarant wording, and Juana maternal surname; entry 514 child name and father field; and entry 515 Leiva/Neira surname conflict. |
