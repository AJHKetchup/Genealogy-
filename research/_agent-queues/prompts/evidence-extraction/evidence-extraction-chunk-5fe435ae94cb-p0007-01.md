...
| --- | --- | --- | --- |
| `research/_staging/reviews/identity-analysis-chunk-1c839b39d83e-p0007-01-dario-arturo-pulgar-identity-candidate-postconv-identity-analysis-20260525123132187-proof-review-postconv-proof-review-20260525145744771.md` | `research/_staging/identity-analysis/identity-analysis-chunk-1c839b39d83e-p0007-01-dario-arturo-pulgar-identity-candidate-postconv-identity-analysis-20260525123132187.md` | `hold_for_identity_bridge` | Keep this staged draft on hold. Reconcile the packet/chunk metadata mismatch, review an identity-bearing CV page from the same source, and review the page-6/page-7 boundary before promoting page-7 occupational facts. Require a separate reviewed bridge from document-level `Dario Arturo Pulgar` to canonical `Dario Arturo Pulgar-Smith` before attaching this CV page to the canonical person. |
