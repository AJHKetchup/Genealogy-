...
| `research/_staging/reviews/identity-analysis-id-stage-chunk-27856e440ba9-p0135-01-pulgar-arriagada-postconv-identity-analysis-20260530032230860-proof-review-postconv-proof-review-20260530181649196.md` | `research/_staging/identity-analysis/identity-analysis-id-stage-chunk-27856e440ba9-p0135-01-pulgar-arriagada-postconv-identity-analysis-20260530032230860.md` | `hold` | Hold this staged draft from canonical promotion. First recover or regenerate the rendered page image for source page 135 and perform page-image QA of the heading and intervention text. After image QA, run a separate identity-bridge proof review using identity-bearing convention records before attaching the page-local `M. Pulgar-Arriagada` intervention to any fuller named candidate. |
...
| `research/_staging/reviews/identity-analysis-id-stage-chunk-27856e440ba9-p0135-01-pulgar-arriagada-postconv-identity-analysis-20260530032703013-proof-review-postconv-proof-review-20260530181826744.md` | `research/_staging/identity-analysis/identity-analysis-id-stage-chunk-27856e440ba9-p0135-01-pulgar-arriagada-postconv-identity-analysis-20260530032703013.md` | `hold` | Hold from canonical promotion. The next action is to obtain or regenerate the rendered page image for source page 135 and visually verify the heading and the `jjas` OCR artifact before any canonical quotation or translation. After image QA, run a separate identity-bridge proof review against identity-bearing convention delegate lists before attaching this page-local intervention to a fuller Dario Pulgar-Arriagada candidate. |
