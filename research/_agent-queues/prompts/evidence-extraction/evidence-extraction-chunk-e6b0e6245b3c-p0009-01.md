...
| `research/_staging/reviews/proof-review-identity-analysis-chunk-e6b0e6245b3c-p0009-01-evidence-revision-hold-postconv-proof-review-20260523195846883.md` | `research/_staging/identity-analysis/identity-analysis-chunk-e6b0e6245b3c-p0009-01-evidence-revision-hold.md` | `hold_for_identity_bridge` | Revise the staged draft or downstream queue status to reflect that page-image conversion QA is reconciled, while keeping canonical readiness on `hold_for_identity_bridge`. Run a separate identity-bridge proof review before any canonical promotion. |
...
| `research/_staging/reviews/proof-review-research-staging-identity-analysis-identity-analysis-id-stage-chunk-e6b0e6245b3c-p0009-01-dario-cv-subject-postconv-proof-review-20260523195418529.md` | `research/_staging/identity-analysis/identity-analysis-id-stage-chunk-e6b0e6245b3c-p0009-01-dario-cv-subject.md` | `hold_for_identity_bridge` | Keep this staged identity analysis out of canonical folders. The next useful action is an identity-bridge review using an identity-bearing CV page, title page, signature/contact page, or other accepted local source that explicitly connects document-level `Dario Arturo Pulgar` to canonical `Dario Arturo Pulgar-Smith`. If that bridge is later accepted, page 9 can be considered only for CV-reported education and language claims, not relationship claims. |
