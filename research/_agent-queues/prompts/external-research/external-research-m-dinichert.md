...
- Page references: 2
- Search terms: `M. Dinichert`, `Dinichert`
- Result note: `research/_staging/external-research/m-dinichert.md`
- R2 intake candidate register: `research/_staging/external-research/m-dinichert.md#r2-intake-candidate-register`
...
- Candidate source descriptors and acquisition notes are recorded in `research/_staging/external-research/m-dinichert.md`.
