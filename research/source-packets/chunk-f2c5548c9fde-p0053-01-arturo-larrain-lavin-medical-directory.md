...
No translation is needed for these directory rows beyond interpreting the table columns as name, address, and locality.
...
The page supports scoped directory mentions for the two listed names with associated Santiago addresses. It does not establish family relationships or identity links to other canonical people.
...
The image-reviewed readings resolve the two conversion defects preserved above: the floor marker should be read as `7º Piso`, and the `Merced 250 B` suffix should be read as Latin `B`.

## Promotion Recommendation

Promoted after proof review as directory-listing evidence only. The conversion-review correction note accompanies promotion so the derivative transcript differences remain visible.
